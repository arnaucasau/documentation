...
`FakePoughkeepsie`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py "view source code")
...
`FakePoughkeepsie.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/backends/poughkeepsie/fake_poughkeepsie.py "view source code")
