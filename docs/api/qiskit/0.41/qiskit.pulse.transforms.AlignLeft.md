...
`AlignLeft`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/pulse/transforms/alignments.py "view source code")
...
`AlignLeft.align(schedule)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/pulse/transforms/alignments.py "view source code")
