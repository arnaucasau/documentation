...
`CircuitSampler(backend, statevector=None, param_qobj=False, attach_results=False, caching='last')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/circuit_sampler.py "view source code")
...
`CircuitSampler.clear_cache()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/circuit_sampler.py "view source code")
...
`CircuitSampler.convert(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/circuit_sampler.py "view source code")
...
`CircuitSampler.sample_circuits(circuit_sfns=None, param_bindings=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/circuit_sampler.py "view source code")
