...
`WeightedAdder(num_state_qubits=None, weights=None, name='adder')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/arithmetic/weighted_adder.py "view source code")
