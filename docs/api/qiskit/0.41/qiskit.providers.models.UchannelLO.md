...
`UchannelLO(q, scale)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/backendconfiguration.py "view source code")
...
`classmethod UchannelLO.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/backendconfiguration.py "view source code")
...
`UchannelLO.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/backendconfiguration.py "view source code")
