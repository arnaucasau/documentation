...
`XXDecomposer(euler_basis='U', embodiments=None, backup_optimizer=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/quantum_info/synthesis/xx_decompose/decomposer.py "view source code")
...
`XXDecomposer.num_basis_gates(unitary)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/quantum_info/synthesis/xx_decompose/decomposer.py "view source code")
