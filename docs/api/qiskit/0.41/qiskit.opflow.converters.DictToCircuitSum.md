...
`DictToCircuitSum(traverse=True, convert_dicts=True, convert_vectors=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/dict_to_circuit_sum.py "view source code")
...
`DictToCircuitSum.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/dict_to_circuit_sum.py "view source code")
