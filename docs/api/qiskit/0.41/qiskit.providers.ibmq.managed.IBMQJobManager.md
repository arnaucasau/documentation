...
`IBMQJobManager`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/managed/ibmqjobmanager.py "view source code")
...
`IBMQJobManager.job_sets(name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/managed/ibmqjobmanager.py "view source code")
...
`IBMQJobManager.report(detailed=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/managed/ibmqjobmanager.py "view source code")
...
`IBMQJobManager.retrieve_job_set(job_set_id, provider, refresh=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/managed/ibmqjobmanager.py "view source code")
...
`IBMQJobManager.run(experiments, backend, name=None, max_experiments_per_job=None, job_share_level=None, job_tags=None, **run_config)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/managed/ibmqjobmanager.py "view source code")
