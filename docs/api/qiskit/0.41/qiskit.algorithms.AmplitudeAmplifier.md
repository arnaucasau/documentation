...
`AmplitudeAmplifier`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py "view source code")
...
`abstract AmplitudeAmplifier.amplify(amplification_problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/amplitude_amplifiers/amplitude_amplifier.py "view source code")
