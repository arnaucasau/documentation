...
`Permutation(num_qubits, pattern=None, seed=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/generalized_gates/permutation.py "view source code")
...
![../\_images/qiskit-circuit-library-Permutation-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-Permutation-1.png)

**Expanded Circuit:**

![../\_images/qiskit-circuit-library-Permutation-2.png](/images/api/qiskit/0.41/qiskit-circuit-library-Permutation-2.png)
