...
`LearningRate(learning_rate)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/optimizers/optimizer_utils/learning_rate.py "view source code")
...
`LearningRate.send(value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/optimizers/optimizer_utils/learning_rate.py "view source code")
...
`LearningRate.throw(typ, val=None, tb=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/optimizers/optimizer_utils/learning_rate.py "view source code")
