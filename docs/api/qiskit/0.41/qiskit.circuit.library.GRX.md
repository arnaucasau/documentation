...
`GRX(num_qubits, theta)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/generalized_gates/gr.py "view source code")
...
![../\_images/qiskit-circuit-library-GRX-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-GRX-1.png)
