...
`EvolutionFactory`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/evolutions/evolution_factory.py "view source code")
...
`static EvolutionFactory.build(operator=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/evolutions/evolution_factory.py "view source code")
