...
`SPSAEstimatorGradient(estimator, epsilon, batch_size=1, seed=None, options=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/gradients/spsa_estimator_gradient.py "view source code")
