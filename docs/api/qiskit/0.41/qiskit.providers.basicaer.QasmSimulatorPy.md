...
`QasmSimulatorPy(configuration=None, provider=None, **fields)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/basicaer/qasm_simulator.py "view source code")
...
`QasmSimulatorPy.run(qobj, **backend_options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/basicaer/qasm_simulator.py "view source code")
...
`QasmSimulatorPy.run_experiment(experiment)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/basicaer/qasm_simulator.py "view source code")
