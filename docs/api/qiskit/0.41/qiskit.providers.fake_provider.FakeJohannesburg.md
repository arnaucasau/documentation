...
`FakeJohannesburg`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/backends/johannesburg/fake_johannesburg.py "view source code")
