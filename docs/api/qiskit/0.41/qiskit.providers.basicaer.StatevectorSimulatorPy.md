...
`StatevectorSimulatorPy(configuration=None, provider=None, **fields)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/basicaer/statevector_simulator.py "view source code")
