...
`ConvertConditionsToIfOps(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/utils/convert_conditions_to_if_ops.py "view source code")
...
`ConvertConditionsToIfOps.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/utils/convert_conditions_to_if_ops.py "view source code")
