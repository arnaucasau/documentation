...
`TextProgressBar(output_handler=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/tools/events/progressbar.py "view source code")
...
`TextProgressBar.start(iterations)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/tools/events/progressbar.py "view source code")
...
`TextProgressBar.update(n)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/tools/events/progressbar.py "view source code")
