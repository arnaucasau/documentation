...
`SingleQubitUnitary(unitary_matrix, mode='ZYZ', up_to_diagonal=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/extensions/quantum_initializer/squ.py "view source code")
...
`SingleQubitUnitary.inverse()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/extensions/quantum_initializer/squ.py "view source code")
...
`SingleQubitUnitary.validate_parameter(parameter)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/extensions/quantum_initializer/squ.py "view source code")
