...
`ClassicalFunction(source, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/classicalfunction/classicalfunction.py "view source code")
...
`ClassicalFunction.compile()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/classicalfunction/classicalfunction.py "view source code")
...
`ClassicalFunction.simulate(bitstring)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/classicalfunction/classicalfunction.py "view source code")
...
`ClassicalFunction.simulate_all()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/classicalfunction/classicalfunction.py "view source code")
...
`ClassicalFunction.synth(registerless=True, synthesizer=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/classicalfunction/classicalfunction.py "view source code")
