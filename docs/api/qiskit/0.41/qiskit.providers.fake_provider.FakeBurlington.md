...
`FakeBurlington`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/backends/burlington/fake_burlington.py "view source code")
