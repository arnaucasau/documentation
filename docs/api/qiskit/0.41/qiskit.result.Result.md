...
`Result(backend_name, backend_version, qobj_id, job_id, success, results, date=None, status=None, header=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`Result.data(experiment=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`classmethod Result.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`Result.get_counts(experiment=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`Result.get_memory(experiment=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`Result.get_statevector(experiment=None, decimals=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`Result.get_unitary(experiment=None, decimals=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
...
`Result.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/result.py "view source code")
