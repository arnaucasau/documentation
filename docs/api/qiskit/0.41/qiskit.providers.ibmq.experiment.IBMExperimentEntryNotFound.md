...
`IBMExperimentEntryNotFound(*message)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/experiment/exceptions.py "view source code")
