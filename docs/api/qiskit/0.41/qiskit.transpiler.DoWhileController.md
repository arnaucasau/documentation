...
`DoWhileController(passes, options=None, do_while=None, **partial_controller)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/runningpassmanager.py "view source code")
