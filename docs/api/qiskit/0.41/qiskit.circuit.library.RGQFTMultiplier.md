...
`RGQFTMultiplier(num_state_qubits, num_result_qubits=None, name='RGQFTMultiplier')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/arithmetic/multipliers/rg_qft_multiplier.py "view source code")
