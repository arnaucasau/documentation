...
`PulseQobj(qobj_id, config, experiments, header=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/pulse_qobj.py "view source code")
...
`classmethod PulseQobj.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/pulse_qobj.py "view source code")
...
`PulseQobj.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/pulse_qobj.py "view source code")
