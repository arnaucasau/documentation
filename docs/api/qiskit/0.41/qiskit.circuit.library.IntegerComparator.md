...
`IntegerComparator(num_state_qubits=None, value=None, geq=True, name='cmp')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/arithmetic/integer_comparator.py "view source code")
