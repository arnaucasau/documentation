...
`InnerProduct(num_qubits)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/boolean_logic/inner_product.py "view source code")
...
![../\_images/qiskit-circuit-library-InnerProduct-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-InnerProduct-1.png)
