...
`EvolutionSynthesis`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/synthesis/evolution/evolution_synthesis.py "view source code")
...
`abstract EvolutionSynthesis.synthesize(evolution)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/synthesis/evolution/evolution_synthesis.py "view source code")
