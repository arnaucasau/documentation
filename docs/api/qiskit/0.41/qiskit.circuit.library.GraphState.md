...
`GraphState(adjacency_matrix)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/graph_state.py "view source code")
...
![../\_images/qiskit-circuit-library-GraphState-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-GraphState-1.png)
