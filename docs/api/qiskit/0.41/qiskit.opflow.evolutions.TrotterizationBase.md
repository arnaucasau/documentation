...
`TrotterizationBase(reps=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/evolutions/trotterizations/trotterization_base.py "view source code")
...
`abstract TrotterizationBase.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/evolutions/trotterizations/trotterization_base.py "view source code")
