...
`TranslateParameterizedGates(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/basis/translate_parameterized.py "view source code")
...
`TranslateParameterizedGates.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/basis/translate_parameterized.py "view source code")
