...
`Command(name, qubits=None, sequence=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/pulsedefaults.py "view source code")
...
`classmethod Command.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/pulsedefaults.py "view source code")
...
`Command.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/pulsedefaults.py "view source code")
