...
`synth_clifford_full(clifford, method=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/synthesis/clifford/clifford_decompose_full.py "view source code")
