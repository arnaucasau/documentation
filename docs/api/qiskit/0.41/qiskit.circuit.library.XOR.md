...
`XOR(num_qubits, amount=None, seed=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/boolean_logic/quantum_xor.py "view source code")
...
![../\_images/qiskit-circuit-library-XOR-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-XOR-1.png)
