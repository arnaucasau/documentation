...
`Estimator(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, observables: Iterable[SparsePauliOp] | SparsePauliOp | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/primitives/estimator.py "view source code")
...
`Estimator.close()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/primitives/estimator.py "view source code")
