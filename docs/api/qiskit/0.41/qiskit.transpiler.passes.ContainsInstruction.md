...
`ContainsInstruction(instruction_name, recurse=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/utils/contains_instruction.py "view source code")
...
`ContainsInstruction.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/utils/contains_instruction.py "view source code")
