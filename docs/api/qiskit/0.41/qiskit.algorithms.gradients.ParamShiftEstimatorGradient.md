...
`ParamShiftEstimatorGradient(estimator, options=None, derivative_type=DerivativeType.REAL)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/gradients/param_shift_estimator_gradient.py "view source code")
