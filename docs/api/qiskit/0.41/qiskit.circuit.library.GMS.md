...
`GMS(num_qubits, theta)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/generalized_gates/gms.py "view source code")
...
![../\_images/qiskit-circuit-library-GMS-1.png](/images/api/qiskit/0.41/qiskit-circuit-library-GMS-1.png)
