...
`LieTrotter(reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/synthesis/evolution/lie_trotter.py "view source code")
...
`LieTrotter.synthesize(evolution)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/synthesis/evolution/lie_trotter.py "view source code")
