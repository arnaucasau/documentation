...
`SetIOLatency(clbit_write_latency=0, conditional_latency=0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py "view source code")
...
`SetIOLatency.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/scheduling/scheduling/set_io_latency.py "view source code")
