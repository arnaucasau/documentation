...
`PulseQobjExperiment(instructions, config=None, header=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/pulse_qobj.py "view source code")
...
`classmethod PulseQobjExperiment.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/pulse_qobj.py "view source code")
...
`PulseQobjExperiment.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/pulse_qobj.py "view source code")
