...
`AccountProvider(credentials, factory)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/accountprovider.py "view source code")
...
`AccountProvider.backends(name=None, filters=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/accountprovider.py "view source code")
...
`AccountProvider.has_service(name)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/accountprovider.py "view source code")
...
`AccountProvider.service(name)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/accountprovider.py "view source code")
...
`AccountProvider.services()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/ibmq/accountprovider.py "view source code")
