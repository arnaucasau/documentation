...
`AlignFunc(duration, func)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/pulse/transforms/alignments.py "view source code")
...
`AlignFunc.align(schedule)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/pulse/transforms/alignments.py "view source code")
...
`AlignFunc.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/pulse/transforms/alignments.py "view source code")
