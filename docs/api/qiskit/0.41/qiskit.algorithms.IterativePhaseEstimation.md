...
`IterativePhaseEstimation(num_iterations, quantum_instance=None, sampler=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/phase_estimators/ipe.py "view source code")
...
`IterativePhaseEstimation.construct_circuit(unitary, state_preparation, k, omega=0.0, measurement=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/phase_estimators/ipe.py "view source code")
...
`IterativePhaseEstimation.estimate(unitary, state_preparation)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/phase_estimators/ipe.py "view source code")
