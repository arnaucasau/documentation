...
`IfElseOp(condition, true_body, false_body=None, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/controlflow/if_else.py "view source code")
...
`IfElseOp.c_if(classical, val)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/controlflow/if_else.py "view source code")
...
`IfElseOp.replace_blocks(blocks)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/controlflow/if_else.py "view source code")
