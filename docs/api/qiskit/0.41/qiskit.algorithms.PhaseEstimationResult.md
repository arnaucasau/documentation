...
`PhaseEstimationResult(num_evaluation_qubits, circuit_result, phases)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/phase_estimators/phase_estimation_result.py "view source code")
...
`PhaseEstimationResult.filter_phases(cutoff=0.0, as_float=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/phase_estimators/phase_estimation_result.py "view source code")
