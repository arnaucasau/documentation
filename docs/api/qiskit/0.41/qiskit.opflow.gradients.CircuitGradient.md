...
`CircuitGradient`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py "view source code")
...
`abstract CircuitGradient.convert(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/gradients/circuit_gradients/circuit_gradient.py "view source code")
