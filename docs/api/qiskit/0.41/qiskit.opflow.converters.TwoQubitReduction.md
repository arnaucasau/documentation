...
`TwoQubitReduction(num_particles)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/two_qubit_reduction.py "view source code")
...
`TwoQubitReduction.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/converters/two_qubit_reduction.py "view source code")
