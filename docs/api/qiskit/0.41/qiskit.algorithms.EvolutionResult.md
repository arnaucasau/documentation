...
`EvolutionResult(evolved_state, aux_ops_evaluated=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/evolvers/evolution_result.py "view source code")
