...
`Fake1Q`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/fake_1q.py "view source code")
...
`Fake1Q.defaults()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/fake_1q.py "view source code")
...
`Fake1Q.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/fake_provider/fake_1q.py "view source code")
