...
`classmethod QasmQobjConfig.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/qasm_qobj.py "view source code")
...
`QasmQobjConfig.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/qobj/qasm_qobj.py "view source code")
