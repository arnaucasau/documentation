...
`AerProvider`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit_aer/aerprovider.py "view source code")
...
`AerProvider.backends(name=None, filters=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit_aer/aerprovider.py "view source code")
...
`AerProvider.get_backend(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit_aer/aerprovider.py "view source code")
