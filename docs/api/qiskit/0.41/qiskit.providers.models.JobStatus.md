...
`JobStatus(job_id, status, status_msg, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/jobstatus.py "view source code")
...
`classmethod JobStatus.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/jobstatus.py "view source code")
...
`JobStatus.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/providers/models/jobstatus.py "view source code")
