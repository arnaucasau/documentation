...
`DenseLayout(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/layout/dense_layout.py "view source code")
...
`DenseLayout.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/layout/dense_layout.py "view source code")
