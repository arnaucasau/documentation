...
`GradientBase(grad_method='param_shift', **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/opflow/gradients/gradient_base.py "view source code")
