...
`PauliGate(label)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/generalized_gates/pauli.py "view source code")
...
`PauliGate.inverse()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/generalized_gates/pauli.py "view source code")
...
`PauliGate.validate_parameter(parameter)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/circuit/library/generalized_gates/pauli.py "view source code")
