...
`BasicSynthesisPermutation`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/synthesis/high_level_synthesis.py "view source code")
...
`BasicSynthesisPermutation.run(high_level_object, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/passes/synthesis/high_level_synthesis.py "view source code")
