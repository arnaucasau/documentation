...
`HHL(epsilon=0.01, expectation=None, quantum_instance=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/linear_solvers/hhl.py "view source code")
...
`HHL.construct_circuit(matrix, vector, neg_vals=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/linear_solvers/hhl.py "view source code")
...
`HHL.solve(matrix, vector, observable=None, observable_circuit=None, post_processing=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/algorithms/linear_solvers/hhl.py "view source code")
