...
`synth_cnotdihedral_general(elem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/synthesis/cnotdihedral/cnotdihedral_decompose_general.py "view source code")
