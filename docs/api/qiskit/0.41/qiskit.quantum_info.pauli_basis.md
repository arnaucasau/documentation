...
`pauli_basis(num_qubits, weight=False, pauli_list=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/quantum_info/operators/symplectic/pauli_utils.py "view source code")
