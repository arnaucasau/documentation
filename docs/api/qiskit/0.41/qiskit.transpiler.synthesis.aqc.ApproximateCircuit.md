...
`ApproximateCircuit(num_qubits, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/synthesis/aqc/approximate.py "view source code")
...
`abstract ApproximateCircuit.build(thetas)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/transpiler/synthesis/aqc/approximate.py "view source code")
