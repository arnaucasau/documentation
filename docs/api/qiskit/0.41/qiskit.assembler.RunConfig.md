...
`RunConfig(shots=None, max_credits=None, seed_simulator=None, memory=None, parameter_binds=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/assembler/run_config.py "view source code")
...
`classmethod RunConfig.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/assembler/run_config.py "view source code")
...
`RunConfig.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/assembler/run_config.py "view source code")
