...
`Counts(data, time_taken=None, creg_sizes=None, memory_slots=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/counts.py "view source code")
...
`Counts.hex_outcomes()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/counts.py "view source code")
...
`Counts.int_outcomes()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/counts.py "view source code")
...
`Counts.most_frequent()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/counts.py "view source code")
...
`Counts.shots()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.41/qiskit/result/counts.py "view source code")
