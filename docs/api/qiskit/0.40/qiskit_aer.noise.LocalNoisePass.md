...
`LocalNoisePass(func, op_types=None, method='append')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/noise/passes/local_noise_pass.py "view source code")
...
`LocalNoisePass.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/noise/passes/local_noise_pass.py "view source code")
