...
`RuntimeProgram.parameters()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/runtime_program.py "view source code")
...
`RuntimeProgram.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/runtime_program.py "view source code")
