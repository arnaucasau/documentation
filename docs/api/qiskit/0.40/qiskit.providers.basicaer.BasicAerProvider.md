...
`BasicAerProvider`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerprovider.py "view source code")
...
`BasicAerProvider.backends(name=None, filters=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerprovider.py "view source code")
...
`BasicAerProvider.get_backend(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerprovider.py "view source code")
