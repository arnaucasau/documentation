...
`duffing_system_model(dim_oscillators, oscillator_freqs, anharm_freqs, drive_strengths, coupling_dict, dt)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/pulse/system_models/duffing_model_generators.py "view source code")
