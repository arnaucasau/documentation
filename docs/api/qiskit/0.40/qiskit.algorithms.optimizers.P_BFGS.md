...
`P_BFGS(maxfun=1000, ftol=2.220446049250313e-15, iprint=- 1, max_processes=None, options=None, max_evals_grouped=1, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/p_bfgs.py "view source code")
...
`P_BFGS.minimize(fun, x0, jac=None, bounds=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/p_bfgs.py "view source code")
