...
`WhileLoopOp(condition, body, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/controlflow/while_loop.py "view source code")
...
`WhileLoopOp.c_if(classical, val)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/controlflow/while_loop.py "view source code")
...
`WhileLoopOp.replace_blocks(blocks)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/controlflow/while_loop.py "view source code")
