...
`Gate(name, num_qubits, params, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/gate.py "view source code")
...
`Gate.broadcast_arguments(qargs, cargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/gate.py "view source code")
...
`Gate.control(num_ctrl_qubits=1, label=None, ctrl_state=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/gate.py "view source code")
...
`Gate.power(exponent)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/gate.py "view source code")
...
`Gate.to_matrix()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/gate.py "view source code")
...
`Gate.validate_parameter(parameter)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/gate.py "view source code")
