...
`FakeQasmSimulator`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/fake_qasm_simulator.py "view source code")
...
`FakeQasmSimulator.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/fake_qasm_simulator.py "view source code")
