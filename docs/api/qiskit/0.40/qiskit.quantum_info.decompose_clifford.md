...
`decompose_clifford(clifford, method=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/quantum_info/synthesis/clifford_decompose.py "view source code")
