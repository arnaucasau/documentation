...
`add_implicit_acquires(schedule, meas_map)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/transforms/canonicalization.py "view source code")
