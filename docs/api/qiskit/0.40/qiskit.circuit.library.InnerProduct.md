...
`InnerProduct(num_qubits)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/library/boolean_logic/inner_product.py "view source code")
...
([Source code](qiskit-circuit-library-InnerProduct-1.py), [png](qiskit-circuit-library-InnerProduct-1.png), [hires.png](qiskit-circuit-library-InnerProduct-1.hires.png), [pdf](qiskit-circuit-library-InnerProduct-1.pdf))

![../\_images/qiskit-circuit-library-InnerProduct-1.png](/images/api/qiskit/0.40/qiskit-circuit-library-InnerProduct-1.png)
