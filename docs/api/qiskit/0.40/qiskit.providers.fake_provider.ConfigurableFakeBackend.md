...
`ConfigurableFakeBackend.defaults()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/utils/configurable_backend.py "view source code")
...
`ConfigurableFakeBackend.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/utils/configurable_backend.py "view source code")
