...
`basic_device_readout_errors(properties=None, target=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/noise/device/models.py "view source code")
