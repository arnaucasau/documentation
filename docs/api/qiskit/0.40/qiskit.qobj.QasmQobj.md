...
`QasmQobj(qobj_id=None, config=None, experiments=None, header=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
...
`classmethod QasmQobj.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
...
`QasmQobj.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
