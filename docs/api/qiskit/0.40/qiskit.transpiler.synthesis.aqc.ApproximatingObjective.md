...
`ApproximatingObjective`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/synthesis/aqc/approximate.py "view source code")
...
`abstract ApproximatingObjective.gradient(param_values)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/synthesis/aqc/approximate.py "view source code")
...
`abstract ApproximatingObjective.objective(param_values)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/synthesis/aqc/approximate.py "view source code")
