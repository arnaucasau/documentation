...
`QasmQobjExperimentConfig(calibrations=None, qubit_lo_freq=None, meas_lo_freq=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
...
`classmethod QasmQobjExperimentConfig.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
...
`QasmQobjExperimentConfig.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
