...
`ExactReciprocal(num_state_qubits, scaling, neg_vals=False, name='1/x')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/library/arithmetic/exact_reciprocal.py "view source code")
