...
`Layout2qDistance(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/layout/layout_2q_distance.py "view source code")
...
`Layout2qDistance.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/layout/layout_2q_distance.py "view source code")
