...
`save_unitary(self, label='unitary', pershot=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/library/save_instructions/save_unitary.py "view source code")
