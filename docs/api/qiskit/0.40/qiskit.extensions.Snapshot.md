...
`Snapshot(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/extensions/simulator/snapshot.py "view source code")
...
`Snapshot.assemble()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/extensions/simulator/snapshot.py "view source code")
...
`Snapshot.c_if(classical, val)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/extensions/simulator/snapshot.py "view source code")
...
`Snapshot.inverse()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/extensions/simulator/snapshot.py "view source code")
