...
`transpile_quantum_error(error, **transpile_kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/utils/noise_transformation.py "view source code")
