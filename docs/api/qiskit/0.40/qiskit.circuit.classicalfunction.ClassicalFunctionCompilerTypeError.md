...
`ClassicalFunctionCompilerTypeError(*message)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/classicalfunction/exceptions.py "view source code")
