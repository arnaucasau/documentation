...
`ParameterVector(name, length=0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/parametervector.py "view source code")
...
`ParameterVector.index(value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/parametervector.py "view source code")
...
`ParameterVector.resize(length)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/parametervector.py "view source code")
