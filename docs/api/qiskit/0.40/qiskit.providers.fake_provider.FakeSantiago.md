...
`FakeSantiago`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/santiago/fake_santiago.py "view source code")
