...
`BasicAerJob(backend, job_id, result)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerjob.py "view source code")
...
`BasicAerJob.backend()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerjob.py "view source code")
...
`BasicAerJob.result(timeout=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerjob.py "view source code")
...
`BasicAerJob.status()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerjob.py "view source code")
...
`BasicAerJob.submit()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/basicaer/basicaerjob.py "view source code")
