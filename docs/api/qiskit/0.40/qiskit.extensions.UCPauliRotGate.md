...
`UCPauliRotGate(angle_list, rot_axis)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/extensions/quantum_initializer/uc_pauli_rot.py "view source code")
