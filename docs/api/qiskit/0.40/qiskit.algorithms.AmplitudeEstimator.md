...
`AmplitudeEstimator`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py "view source code")
...
`abstract AmplitudeEstimator.estimate(estimation_problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/amplitude_estimators/amplitude_estimator.py "view source code")
