...
`synth_permutation_basic(pattern)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/synthesis/permutation/permutation_full.py "view source code")
