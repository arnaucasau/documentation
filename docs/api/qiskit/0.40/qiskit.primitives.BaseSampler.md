...
`BaseSampler(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/primitives/base/base_sampler.py "view source code")
...
`BaseSampler.close()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/primitives/base/base_sampler.py "view source code")
...
`BaseSampler.run(circuits, parameter_values=None, **run_options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/primitives/base/base_sampler.py "view source code")
