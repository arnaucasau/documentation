...
`FakeOpenPulse2Q`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/fake_openpulse_2q.py "view source code")
...
`FakeOpenPulse2Q.defaults()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/fake_openpulse_2q.py "view source code")
...
`FakeOpenPulse2Q.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/fake_openpulse_2q.py "view source code")
