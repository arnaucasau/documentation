...
`IMFIL(maxiter=1000)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/imfil.py "view source code")
...
`IMFIL.get_support_level()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/imfil.py "view source code")
...
`IMFIL.minimize(fun, x0, jac=None, bounds=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/imfil.py "view source code")
