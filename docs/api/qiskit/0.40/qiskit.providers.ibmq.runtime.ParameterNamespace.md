...
`ParameterNamespace(parameters)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/runtime_program.py "view source code")
...
`ParameterNamespace.validate()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/runtime_program.py "view source code")
