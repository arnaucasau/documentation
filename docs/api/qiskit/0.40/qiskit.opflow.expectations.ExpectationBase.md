...
`ExpectationBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/expectation_base.py "view source code")
...
`abstract ExpectationBase.compute_variance(exp_op)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/expectation_base.py "view source code")
...
`abstract ExpectationBase.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/expectation_base.py "view source code")
