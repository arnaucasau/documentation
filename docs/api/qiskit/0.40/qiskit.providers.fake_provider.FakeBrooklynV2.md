...
`FakeBrooklynV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/brooklyn/fake_brooklyn.py "view source code")
