...
`EvolutionBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/evolutions/evolution_base.py "view source code")
...
`abstract EvolutionBase.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/evolutions/evolution_base.py "view source code")
