...
`FakeCambridge`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/cambridge/fake_cambridge.py "view source code")
