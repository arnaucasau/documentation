...
`dag_to_dagdependency(dag, create_preds_and_succs=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/converters/dag_to_dagdependency.py "view source code")
