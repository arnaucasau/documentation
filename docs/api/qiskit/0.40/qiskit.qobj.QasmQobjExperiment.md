...
`QasmQobjExperiment(config=None, header=None, instructions=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
...
`classmethod QasmQobjExperiment.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
...
`QasmQobjExperiment.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/qasm_qobj.py "view source code")
