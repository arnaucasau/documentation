...
`FakeAuckland`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/auckland/fake_auckland.py "view source code")
