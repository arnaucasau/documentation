...
`classmethod PulseQobjInstruction.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/pulse_qobj.py "view source code")
...
`PulseQobjInstruction.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/pulse_qobj.py "view source code")
