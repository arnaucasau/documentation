...
`LinearSystemObservable`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/linear_solvers/observables/linear_system_observable.py "view source code")
...
`abstract LinearSystemObservable.evaluate_classically(solution)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/linear_solvers/observables/linear_system_observable.py "view source code")
...
`abstract LinearSystemObservable.observable(num_qubits)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/linear_solvers/observables/linear_system_observable.py "view source code")
...
`abstract LinearSystemObservable.observable_circuit(num_qubits)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/linear_solvers/observables/linear_system_observable.py "view source code")
...
`abstract LinearSystemObservable.post_processing(solution, num_qubits, scaling=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/linear_solvers/observables/linear_system_observable.py "view source code")
