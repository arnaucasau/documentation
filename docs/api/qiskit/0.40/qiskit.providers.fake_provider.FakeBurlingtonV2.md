...
`FakeBurlingtonV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/burlington/fake_burlington.py "view source code")
