...
`FakeRochester`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/rochester/fake_rochester.py "view source code")
