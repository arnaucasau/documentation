...
`visualize_transition(circuit, trace=False, saveas=None, fpg=100, spg=2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/visualization/transition_visualization.py "view source code")
