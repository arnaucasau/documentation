...
`InstructionDurations(instruction_durations=None, dt=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/instruction_durations.py "view source code")
...
`classmethod InstructionDurations.from_backend(backend)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/instruction_durations.py "view source code")
...
`InstructionDurations.get(inst, qubits, unit='dt', parameters=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/instruction_durations.py "view source code")
...
`InstructionDurations.units_used()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/instruction_durations.py "view source code")
...
`InstructionDurations.update(inst_durations, dt=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/instruction_durations.py "view source code")
