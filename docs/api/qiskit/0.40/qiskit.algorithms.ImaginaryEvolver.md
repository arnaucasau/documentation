...
`ImaginaryEvolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/evolvers/imaginary_evolver.py "view source code")
...
`abstract ImaginaryEvolver.evolve(evolution_problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/evolvers/imaginary_evolver.py "view source code")
