...
`OneQubitEulerDecomposer(basis='U3', use_dag=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
...
`OneQubitEulerDecomposer.angles(unitary)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
...
`OneQubitEulerDecomposer.angles_and_phase(unitary)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
...
`OneQubitEulerDecomposer.build_circuit(gates, global_phase)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
