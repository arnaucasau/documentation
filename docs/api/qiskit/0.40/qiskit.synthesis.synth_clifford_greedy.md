...
`synth_clifford_greedy(clifford)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/synthesis/clifford/clifford_decompose_greedy.py "view source code")
