...
`HiddenLinearFunction(adjacency_matrix)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/library/hidden_linear_function.py "view source code")
...
> ([Source code](qiskit-circuit-library-HiddenLinearFunction-1.py), [png](qiskit-circuit-library-HiddenLinearFunction-1.png), [hires.png](qiskit-circuit-library-HiddenLinearFunction-1.hires.png), [pdf](qiskit-circuit-library-HiddenLinearFunction-1.pdf))
>
> ![../\_images/qiskit-circuit-library-HiddenLinearFunction-1.png](/images/api/qiskit/0.40/qiskit-circuit-library-HiddenLinearFunction-1.png)
