...
`make_cnot_network(num_qubits, network_layout='spin', connectivity_type='full', depth=0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/synthesis/aqc/cnot_structures.py "view source code")
