...
`RuntimeDecoder(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/utils.py "view source code")
...
`RuntimeDecoder.object_hook(obj)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/utils.py "view source code")
