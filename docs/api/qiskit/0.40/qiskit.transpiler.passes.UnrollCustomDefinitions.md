...
`UnrollCustomDefinitions(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/basis/unroll_custom_definitions.py "view source code")
...
`UnrollCustomDefinitions.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/basis/unroll_custom_definitions.py "view source code")
