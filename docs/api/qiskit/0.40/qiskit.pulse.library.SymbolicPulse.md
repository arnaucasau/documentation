...
`SymbolicPulse(pulse_type, duration, parameters=None, name=None, limit_amplitude=None, envelope=None, constraints=None, valid_amp_conditions=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/symbolic_pulses.py "view source code")
...
([Source code](qiskit-pulse-library-SymbolicPulse-1.py), [png](qiskit-pulse-library-SymbolicPulse-1.png), [hires.png](qiskit-pulse-library-SymbolicPulse-1.hires.png), [pdf](qiskit-pulse-library-SymbolicPulse-1.pdf))

![../\_images/qiskit-pulse-library-SymbolicPulse-1.png](/images/api/qiskit/0.40/qiskit-pulse-library-SymbolicPulse-1.png)
...
`SymbolicPulse.get_waveform()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/symbolic_pulses.py "view source code")
...
`SymbolicPulse.is_parameterized()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/symbolic_pulses.py "view source code")
...
`SymbolicPulse.validate_parameters()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/symbolic_pulses.py "view source code")
