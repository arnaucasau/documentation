...
`ExpectationFactory`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/expectation_factory.py "view source code")
...
`static ExpectationFactory.build(operator, backend=None, include_custom=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/expectation_factory.py "view source code")
