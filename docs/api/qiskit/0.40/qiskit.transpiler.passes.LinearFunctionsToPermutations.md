...
`LinearFunctionsToPermutations(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py "view source code")
...
`LinearFunctionsToPermutations.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/synthesis/linear_functions_synthesis.py "view source code")
