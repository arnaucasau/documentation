...
`Snapshot(label, snapshot_type='statevector', name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/instructions/snapshot.py "view source code")
...
`Snapshot.is_parameterized()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/instructions/snapshot.py "view source code")
