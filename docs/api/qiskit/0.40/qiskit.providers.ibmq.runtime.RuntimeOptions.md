...
`RuntimeOptions(backend_name=None, image=None, log_level=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/runtime_options.py "view source code")
...
`RuntimeOptions.validate()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/ibmq/runtime/runtime_options.py "view source code")
