...
`SolovayKitaevSynthesis`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py "view source code")
...
`SolovayKitaevSynthesis.run(unitary, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/synthesis/solovay_kitaev_synthesis.py "view source code")
