...
`FakeTenerife`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/tenerife/fake_tenerife.py "view source code")
...
`FakeTenerife.properties()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/providers/fake_provider/backends/tenerife/fake_tenerife.py "view source code")
