...
`CRS(max_evals=1000)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/nlopts/crs.py "view source code")
...
`CRS.get_nlopt_optimizer()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/nlopts/crs.py "view source code")
