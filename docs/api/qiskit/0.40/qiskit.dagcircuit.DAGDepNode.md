...
`DAGDepNode.copy()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/dagcircuit/dagdepnode.py "view source code")
...
`static DAGDepNode.semantic_eq(node1, node2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/dagcircuit/dagdepnode.py "view source code")
