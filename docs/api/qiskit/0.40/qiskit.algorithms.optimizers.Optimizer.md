...
`Optimizer`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`abstract Optimizer.get_support_level()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`static Optimizer.gradient_num_diff(x_center, f, epsilon, max_evals_grouped=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`abstract Optimizer.minimize(fun, x0, jac=None, bounds=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`Optimizer.print_options()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`Optimizer.set_max_evals_grouped(limit)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`Optimizer.set_options(**kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
...
`static Optimizer.wrap_function(function, args)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/optimizers/optimizer.py "view source code")
