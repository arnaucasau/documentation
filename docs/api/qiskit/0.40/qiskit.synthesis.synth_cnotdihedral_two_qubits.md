...
`synth_cnotdihedral_two_qubits(elem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/synthesis/cnotdihedral/cnotdihedral_decompose_two_qubits.py "view source code")
