...
`CommutativeInverseCancellation(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py "view source code")
...
`CommutativeInverseCancellation.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py "view source code")
