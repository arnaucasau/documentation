...
`CNOTUnitObjective(num_qubits, cnots)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/synthesis/aqc/cnot_unit_objective.py "view source code")
