...
`AerStatevector(data, dims=None, **configs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`AerStatevector.conjugate()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`classmethod AerStatevector.from_instruction(instruction)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`static AerStatevector.from_int(i, dims)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`classmethod AerStatevector.from_label(label)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`AerStatevector.metadata()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`AerStatevector.sample_memory(shots, qargs=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
...
`AerStatevector.seed(value=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/quantum_info/states/aer_statevector.py "view source code")
