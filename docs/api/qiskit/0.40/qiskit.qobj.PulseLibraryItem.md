...
`PulseLibraryItem(name, samples)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/pulse_qobj.py "view source code")
...
`classmethod PulseLibraryItem.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/pulse_qobj.py "view source code")
...
`PulseLibraryItem.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/qobj/pulse_qobj.py "view source code")
