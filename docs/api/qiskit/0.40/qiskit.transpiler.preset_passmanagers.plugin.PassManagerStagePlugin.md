...
`PassManagerStagePlugin`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/preset_passmanagers/plugin.py "view source code")
...
`abstract PassManagerStagePlugin.pass_manager(pass_manager_config, optimization_level=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/preset_passmanagers/plugin.py "view source code")
