...
`SummedOp(oplist, coeff=1.0, abelian=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.add(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.collapse_summands()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.equals(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.reduce()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.to_circuit()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.to_matrix_op(massive=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
...
`SummedOp.to_pauli_op(massive=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/list_ops/summed_op.py "view source code")
