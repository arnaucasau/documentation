...
`Delay(duration, unit='dt')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/delay.py "view source code")
...
`Delay.broadcast_arguments(qargs, cargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/delay.py "view source code")
...
`Delay.c_if(classical, val)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/delay.py "view source code")
...
`Delay.inverse()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/delay.py "view source code")
...
`Delay.to_matrix()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/delay.py "view source code")
...
`Delay.validate_parameter(parameter)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/delay.py "view source code")
