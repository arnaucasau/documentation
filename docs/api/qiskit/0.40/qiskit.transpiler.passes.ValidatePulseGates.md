...
`ValidatePulseGates(granularity=1, min_length=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py "view source code")
...
`ValidatePulseGates.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/scheduling/alignments/pulse_gate_validation.py "view source code")
