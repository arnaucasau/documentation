...
`Measure`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/measure.py "view source code")
...
`Measure.broadcast_arguments(qargs, cargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/measure.py "view source code")
