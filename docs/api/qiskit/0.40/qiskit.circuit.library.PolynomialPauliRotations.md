...
`PolynomialPauliRotations(num_state_qubits=None, coeffs=None, basis='Y', name='poly')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/circuit/library/arithmetic/polynomial_pauli_rotations.py "view source code")
