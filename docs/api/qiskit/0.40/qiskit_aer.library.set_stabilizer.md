...
`set_stabilizer(self, state)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/library/set_instructions/set_stabilizer.py "view source code")
