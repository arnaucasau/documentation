...
`Sampler(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/primitives/sampler.py "view source code")
...
`Sampler.close()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit_aer/primitives/sampler.py "view source code")
