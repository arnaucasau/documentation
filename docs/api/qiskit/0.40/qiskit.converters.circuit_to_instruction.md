...
`circuit_to_instruction(circuit, parameter_map=None, equivalence_library=None, label=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/converters/circuit_to_instruction.py "view source code")
