...
`NaturalGradient(grad_method='lin_comb', qfi_method='lin_comb_full', regularization=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/gradients/natural_gradient.py "view source code")
...
`NaturalGradient.convert(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/gradients/natural_gradient.py "view source code")
...
`static NaturalGradient.nat_grad_combo_fn(x, regularization=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/gradients/natural_gradient.py "view source code")
