...
`synth_cnotdihedral_full(elem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/synthesis/cnotdihedral/cnotdihedral_decompose_full.py "view source code")
