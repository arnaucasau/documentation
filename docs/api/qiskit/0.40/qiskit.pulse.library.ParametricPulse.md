...
`ParametricPulse(duration, name=None, limit_amplitude=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/parametric_pulses.py "view source code")
...
`abstract ParametricPulse.get_waveform()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/parametric_pulses.py "view source code")
...
`ParametricPulse.is_parameterized()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/parametric_pulses.py "view source code")
...
`abstract ParametricPulse.validate_parameters()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/pulse/library/parametric_pulses.py "view source code")
