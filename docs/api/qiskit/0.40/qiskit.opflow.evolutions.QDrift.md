...
`QDrift(reps=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/evolutions/trotterizations/qdrift.py "view source code")
...
`QDrift.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/evolutions/trotterizations/qdrift.py "view source code")
