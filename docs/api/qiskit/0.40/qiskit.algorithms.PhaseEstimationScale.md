...
`PhaseEstimationScale(bound)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/phase_estimators/phase_estimation_scale.py "view source code")
...
`classmethod PhaseEstimationScale.from_pauli_sum(pauli_sum)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/phase_estimators/phase_estimation_scale.py "view source code")
...
`PhaseEstimationScale.scale_phase(phi, id_coefficient=0.0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/phase_estimators/phase_estimation_scale.py "view source code")
...
`PhaseEstimationScale.scale_phases(phases, id_coefficient=0.0)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/algorithms/phase_estimators/phase_estimation_scale.py "view source code")
