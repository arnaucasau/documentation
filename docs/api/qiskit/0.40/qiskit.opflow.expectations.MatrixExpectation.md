...
`MatrixExpectation`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/matrix_expectation.py "view source code")
...
`MatrixExpectation.compute_variance(exp_op)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/matrix_expectation.py "view source code")
...
`MatrixExpectation.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/opflow/expectations/matrix_expectation.py "view source code")
