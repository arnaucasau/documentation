...
`HighLevelSynthesisPlugin`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/synthesis/plugin.py "view source code")
...
`abstract HighLevelSynthesisPlugin.run(high_level_object, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.40/qiskit/transpiler/passes/synthesis/plugin.py "view source code")
