...
<Class id="qiskit.aqua.algorithms.QGAN" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/distribution_learners/qgan.py" signature="QGAN(data, bounds=None, num_qubits=None, batch_size=500, num_epochs=3000, seed=7, discriminator=None, generator=None, tol_rel_ent=None, snapshot_dir=None, quantum_instance=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.aqua.algorithms.QGAN.set_generator" signature="set_generator(generator_circuit=None, generator_init_params=None, generator_optimizer=None)">
