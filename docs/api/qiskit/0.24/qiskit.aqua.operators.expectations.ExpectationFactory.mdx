...
<Class id="qiskit.aqua.operators.expectations.ExpectationFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/expectation_factory.py" signature="ExpectationFactory" modifiers="class">
