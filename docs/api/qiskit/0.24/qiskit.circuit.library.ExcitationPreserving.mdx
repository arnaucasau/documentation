...
<Class id="qiskit.circuit.library.ExcitationPreserving" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/n_local/excitation_preserving.py" signature="ExcitationPreserving(num_qubits=None, mode='iswap', entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None)" modifiers="class">
...
$$
  ...
  **ValueError** – If the selected mode is not supported.
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.ExcitationPreserving.mirror" signature="mirror()">
