...
<Class id="qiskit.extensions.Snapshot" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/extensions/simulator/snapshot.py" signature="Snapshot(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)" modifiers="class">
  ...
  **ExtensionError** – if snapshot label is invalid.
  ...
  <Function id="qiskit.extensions.Snapshot.__init__" signature="__init__(label, snapshot_type='statevector', num_qubits=0, num_clbits=0, params=None)">
    Create new snapshot instruction.
  ...
  <Function id="qiskit.extensions.Snapshot.mirror" signature="mirror()">
