...
<Class id="qiskit.chemistry.algorithms.pes_samplers.EnergySurfaceBase" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/algorithms/pes_samplers/potentials/potential_base.py" signature="EnergySurfaceBase" modifiers="class">
