...
<Class id="qiskit.aqua.algorithms.MinimumEigensolver" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/minimum_eigen_solvers/minimum_eigen_solver.py" signature="MinimumEigensolver" modifiers="class">
  ...
  <Function id="qiskit.aqua.algorithms.MinimumEigensolver.__init__" signature="__init__()">
