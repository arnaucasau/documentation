...
<Class id="qiskit.circuit.QuantumCircuit" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/quantumcircuit.py" signature="QuantumCircuit(*regs, name=None, global_phase=0)" modifiers="class">
  ...
  *   **regs** (list(`Register`) or list(`int`)) –
  ...
  *   **global\_phase** (*float*) – The global phase of the circuit in radians.
  ...
  **Examples**
  ...
  <Function id="qiskit.circuit.QuantumCircuit.__init__" signature="__init__(*regs, name=None, global_phase=0)">
  ...
  |                                                                                                                                                                         |                                                                                                                                     |
  | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
  | [`__init__`](#qiskit.circuit.QuantumCircuit.__init__ "qiskit.circuit.QuantumCircuit.__init__")(\*regs\[, name, global\_phase])                                          | Initialize self.                                                                                                                    |
  ...
  | [`assign_parameters`](#qiskit.circuit.QuantumCircuit.assign_parameters "qiskit.circuit.QuantumCircuit.assign_parameters")(param\_dict\[, inplace])                      | Assign parameters to new parameters or values.                                                                                      |
  | [`barrier`](#qiskit.circuit.QuantumCircuit.barrier "qiskit.circuit.QuantumCircuit.barrier")(\*qargs)                                                                    | Apply `Barrier`.                                                                                                                    |
  | [`bind_parameters`](#qiskit.circuit.QuantumCircuit.bind_parameters "qiskit.circuit.QuantumCircuit.bind_parameters")(value\_dict)                                        | Assign numeric parameters to values yielding a new circuit.                                                                         |
  ...
  | [`combine`](#qiskit.circuit.QuantumCircuit.combine "qiskit.circuit.QuantumCircuit.combine")(rhs)                                                                        | Append rhs to self if self contains compatible registers.                                                                           |
  ...
  | [`diag_gate`](#qiskit.circuit.QuantumCircuit.diag_gate "qiskit.circuit.QuantumCircuit.diag_gate")(diag, qubit)                                                          | Deprecated version of QuantumCircuit.diagonal.                                                                                      |
  ...
  | [`extend`](#qiskit.circuit.QuantumCircuit.extend "qiskit.circuit.QuantumCircuit.extend")(rhs)                                                                           | Append QuantumCircuit to the right hand side if it contains compatible registers.                                                   |
  ...
  | [`hamiltonian`](#qiskit.circuit.QuantumCircuit.hamiltonian "qiskit.circuit.QuantumCircuit.hamiltonian")(operator, time, qubits\[, label])                               | Apply hamiltonian evolution to to qubits.                                                                                           |
  ...
  | [`initialize`](#qiskit.circuit.QuantumCircuit.initialize "qiskit.circuit.QuantumCircuit.initialize")(params, qubits)                                                    | Apply initialize to circuit.                                                                                                        |
  ...
  | [`mcmt`](#qiskit.circuit.QuantumCircuit.mcmt "qiskit.circuit.QuantumCircuit.mcmt")(gate, control\_qubits, target\_qubits\[, …])                                         | Apply a multi-control, multi-target using a generic gate.                                                                           |
  ...
  | [`mcry`](#qiskit.circuit.QuantumCircuit.mcry "qiskit.circuit.QuantumCircuit.mcry")(theta, q\_controls, q\_target, q\_ancillae)                                          | Apply Multiple-Controlled Y rotation gate                                                                                           |
  ...
  | [`mirror`](#qiskit.circuit.QuantumCircuit.mirror "qiskit.circuit.QuantumCircuit.mirror")()                                                                              | DEPRECATED: use circuit.reverse\_ops().                                                                                             |
  ...
  | [`r`](#qiskit.circuit.QuantumCircuit.r "qiskit.circuit.QuantumCircuit.r")(theta, phi, qubit)                                                                            | Apply `RGate`.                                                                                                                      |
  ...
  <Function id="qiskit.circuit.QuantumCircuit.assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.QuantumCircuit.mirror" signature="mirror()">
