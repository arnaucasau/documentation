...
<Class id="qiskit.pulse.Instruction" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/instruction.py" signature="Instruction(operands, duration, channels, name=None)" modifiers="class">
  ...
  *   [**PulseError**](qiskit.pulse.PulseError "qiskit.pulse.PulseError") – If the input `channels` are not all of type `Channel`.
  ...
  <Function id="qiskit.pulse.Instruction.__init__" signature="__init__(operands, duration, channels, name=None)">
    Instruction initializer.
  ...
  <Attribute id="qiskit.pulse.Instruction.command">
  ...
  <Attribute id="qiskit.pulse.Instruction.timeslots">
