...
<Class id="qiskit.pulse.instructions.SetFrequency" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/frequency.py" signature="SetFrequency(frequency, channel, name=None)" modifiers="class">
...
$$
  ...
  *   **name** (`Optional`\[`str`]) – Name of this set channel frequency instruction.
  ...
  <Attribute id="qiskit.pulse.instructions.SetFrequency.command">
  ...
  <Attribute id="qiskit.pulse.instructions.SetFrequency.timeslots">
