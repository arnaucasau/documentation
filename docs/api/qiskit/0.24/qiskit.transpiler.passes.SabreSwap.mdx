...
<Class id="qiskit.transpiler.passes.SabreSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/routing/sabre_swap.py" signature="SabreSwap(*args, **kwargs)" modifiers="class">
