...
<Class id="qiskit.aqua.components.multiclass_extensions.ErrorCorrectingCode" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/multiclass_extensions/error_correcting_code.py" signature="ErrorCorrectingCode(code_size=4)" modifiers="class">
