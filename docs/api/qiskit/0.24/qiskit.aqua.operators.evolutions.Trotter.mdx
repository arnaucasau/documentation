...
<Class id="qiskit.aqua.operators.evolutions.Trotter" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/evolutions/trotterizations/trotter.py" signature="Trotter(reps=1)" modifiers="class">
