...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/boolean_logic/inner_product.py" signature="InnerProduct(num_qubits)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  <Function id="qiskit.circuit.library.InnerProduct.assign_parameters" signature="assign_parameters(param_dict, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.bind_parameters" signature="bind_parameters(value_dict)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.diag_gate" signature="diag_gate(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.initialize" signature="initialize(params, qubits)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mcmt" signature="mcmt(gate, control_qubits, target_qubits, ancilla_qubits=None, mode='noancilla', *, single_control_gate_fun=None, q_controls=None, q_ancillae=None, q_targets=None)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.InnerProduct.mirror" signature="mirror()">
