...
<Class id="qiskit.transpiler.passes.BasicSwap" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/routing/basic_swap.py" signature="BasicSwap(*args, **kwargs)" modifiers="class">
