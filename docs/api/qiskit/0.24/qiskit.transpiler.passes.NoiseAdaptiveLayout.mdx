...
<Class id="qiskit.transpiler.passes.NoiseAdaptiveLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/layout/noise_adaptive_layout.py" signature="NoiseAdaptiveLayout(*args, **kwargs)" modifiers="class">
