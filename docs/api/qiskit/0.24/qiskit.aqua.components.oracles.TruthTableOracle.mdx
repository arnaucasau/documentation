...
<Class id="qiskit.aqua.components.oracles.TruthTableOracle" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/oracles/truth_table_oracle.py" signature="TruthTableOracle(bitmaps, optimization=False, mct_mode='basic')" modifiers="class">
