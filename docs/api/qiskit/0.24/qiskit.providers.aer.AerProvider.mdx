...
<Class id="qiskit.providers.aer.AerProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/aerprovider.py" signature="AerProvider(*args, **kwargs)" modifiers="class">
  Provider for Qiskit Aer backends.

  ### \_\_init\_\_

  <Function id="qiskit.providers.aer.AerProvider.__init__" signature="__init__(*args, **kwargs)">
