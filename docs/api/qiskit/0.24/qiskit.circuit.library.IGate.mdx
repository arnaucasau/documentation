...
<Class id="qiskit.circuit.library.IGate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/circuit/library/standard_gates/i.py" signature="IGate(label=None)" modifiers="class">
  Identity gate.
