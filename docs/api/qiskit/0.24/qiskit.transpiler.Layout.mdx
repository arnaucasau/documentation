...
<Class id="qiskit.transpiler.Layout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/layout.py" signature="Layout(input_dict=None)" modifiers="class">
  ...
  <Function id="qiskit.transpiler.Layout.from_qubit_list" signature="from_qubit_list(qubit_list)" modifiers="static">
