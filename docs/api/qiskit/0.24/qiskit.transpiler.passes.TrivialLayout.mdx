...
<Class id="qiskit.transpiler.passes.TrivialLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/layout/trivial_layout.py" signature="TrivialLayout(*args, **kwargs)" modifiers="class">
