...
<Class id="qiskit.transpiler.passes.Decompose" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/basis/decompose.py" signature="Decompose(gate=None)" modifiers="class">
