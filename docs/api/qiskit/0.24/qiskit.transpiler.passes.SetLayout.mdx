...
<Class id="qiskit.transpiler.passes.SetLayout" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/layout/set_layout.py" signature="SetLayout(*args, **kwargs)" modifiers="class">
