...
<Class id="qiskit.providers.aer.StatevectorSimulator" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.7/qiskit/providers/aer/backends/statevector_simulator.py" signature="StatevectorSimulator(configuration=None, properties=None, provider=None, **backend_options)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.run" signature="run(qobj, backend_options=None, validate=False, **run_options)">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.set_options" signature="set_options(**backend_options)">
  ...
  <Function id="qiskit.providers.aer.StatevectorSimulator.version" signature="version()">
