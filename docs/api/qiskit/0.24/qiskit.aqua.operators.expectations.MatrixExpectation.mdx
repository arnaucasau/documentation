...
<Class id="qiskit.aqua.operators.expectations.MatrixExpectation" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/operators/expectations/matrix_expectation.py" signature="MatrixExpectation" modifiers="class">
