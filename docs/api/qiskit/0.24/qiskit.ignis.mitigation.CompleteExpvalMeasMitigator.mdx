...
<Class id="qiskit.ignis.mitigation.CompleteExpvalMeasMitigator" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-ignis/tree/stable/0.5/qiskit/ignis/mitigation/expval/complete_mitigator.py" signature="CompleteExpvalMeasMitigator(amat)" modifiers="class">
