...
<Class id="qiskit.transpiler.passes.DAGFixedPoint" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/transpiler/passes/utils/dag_fixed_point.py" signature="DAGFixedPoint(*args, **kwargs)" modifiers="class">
