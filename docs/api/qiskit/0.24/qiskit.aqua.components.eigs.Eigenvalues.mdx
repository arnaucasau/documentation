...
<Class id="qiskit.aqua.components.eigs.Eigenvalues" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/eigs/eigs.py" signature="Eigenvalues" modifiers="class">
