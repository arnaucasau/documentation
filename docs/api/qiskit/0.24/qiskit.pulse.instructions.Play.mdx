...
<Class id="qiskit.pulse.instructions.Play" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/pulse/instructions/play.py" signature="Play(pulse, channel, name=None)" modifiers="class">
  ...
  **Raises**
  ...
  <Attribute id="qiskit.pulse.instructions.Play.command">
  ...
  <Attribute id="qiskit.pulse.instructions.Play.timeslots">
