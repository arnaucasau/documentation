...
<Class id="qiskit.aqua.utils.CircuitFactory" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/utils/circuit_factory.py" signature="CircuitFactory(num_target_qubits)" modifiers="class">
