...
<Class id="qiskit.aqua.algorithms.GroverResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/algorithms/amplitude_amplifiers/grover.py" signature="GroverResult(a_dict=None)" modifiers="class">
  Grover Result.
