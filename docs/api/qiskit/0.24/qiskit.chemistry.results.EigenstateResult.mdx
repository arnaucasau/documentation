...
<Class id="qiskit.chemistry.results.EigenstateResult" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/results/eigenstate_result.py" signature="EigenstateResult(a_dict=None)" modifiers="class">
