...
<Class id="qiskit.qobj.PulseQobj" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/qobj/pulse_qobj.py" signature="PulseQobj(qobj_id, config, experiments, header=None)" modifiers="class">
  A Pulse Qobj.
