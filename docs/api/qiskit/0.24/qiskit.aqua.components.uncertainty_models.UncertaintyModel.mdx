...
<Class id="qiskit.aqua.components.uncertainty_models.UncertaintyModel" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/aqua/components/uncertainty_models/uncertainty_model.py" signature="UncertaintyModel(num_target_qubits)" modifiers="class">
