...
<Class id="qiskit.optimization.problems.LinearExpression" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/linear_expression.py" signature="LinearExpression(quadratic_program, coefficients)" modifiers="class">
