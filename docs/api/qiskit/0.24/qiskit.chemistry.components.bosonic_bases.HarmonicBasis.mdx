...
<Class id="qiskit.chemistry.components.bosonic_bases.HarmonicBasis" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/bosonic_bases/harmonic_basis.py" signature="HarmonicBasis(watson_hamiltonian, basis, truncation_order=3)" modifiers="class">
