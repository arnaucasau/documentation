...
<Class id="qiskit.providers.BaseProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.16/qiskit/providers/baseprovider.py" signature="BaseProvider(*args, **kwargs)" modifiers="class">
