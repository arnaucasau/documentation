...
<Class id="qiskit.chemistry.components.initial_states.VSCF" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/chemistry/components/initial_states/vscf.py" signature="VSCF(basis)" modifiers="class">
