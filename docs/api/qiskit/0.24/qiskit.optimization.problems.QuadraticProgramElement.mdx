...
<Class id="qiskit.optimization.problems.QuadraticProgramElement" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.8/qiskit/optimization/problems/quadratic_program_element.py" signature="QuadraticProgramElement(quadratic_program)" modifiers="class">
