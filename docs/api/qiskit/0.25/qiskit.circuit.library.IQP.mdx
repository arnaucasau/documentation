...
<Class id="qiskit.circuit.library.IQP" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/iqp.py" signature="IQP(interactions)" modifiers="class">
  ...
  **Reference Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.IQP\_0\_0.png](/images/api/qiskit/0.25/qiskit.circuit.library.IQP_0_0.png)
  ...
  **CircuitError** – if the inputs is not as symmetric matrix.
  ...
  <Function id="qiskit.circuit.library.IQP.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.IQP\_4\_0.png](/images/api/qiskit/0.25/qiskit.circuit.library.IQP_4_0.png)
  </Function>
