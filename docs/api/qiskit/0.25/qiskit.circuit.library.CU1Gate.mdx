...
<Class id="qiskit.circuit.library.CU1Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/u1.py" signature="CU1Gate(theta, label=None, ctrl_state=None)" modifiers="class">
  Controlled-U1 gate.
