...
<Class id="qiskit.circuit.library.TwoLocal" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/n_local/two_local.py" signature="TwoLocal(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='TwoLocal')" modifiers="class">
  ...
  *   **initial\_state** (`Optional`\[`Any`]) – A QuantumCircuit object to prepend to the circuit.
  ...
  <Function id="qiskit.circuit.library.TwoLocal.__init__" signature="__init__(num_qubits=None, rotation_blocks=None, entanglement_blocks=None, entanglement='full', reps=3, skip_unentangled_qubits=False, skip_final_rotation_layer=False, parameter_prefix='θ', insert_barriers=False, initial_state=None, name='TwoLocal')">
    Construct a new two-local circuit.
  ...
  | [`compose`](#qiskit.circuit.library.TwoLocal.compose "qiskit.circuit.library.TwoLocal.compose")(other\[, qubits, clbits, front, …])                                                       | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
  ...
  | [`get_instructions`](#qiskit.circuit.library.TwoLocal.get_instructions "qiskit.circuit.library.TwoLocal.get_instructions")(name)                                                          | Get instructions matching name.                                                                                                     |
  ...
  | [`pauli`](#qiskit.circuit.library.TwoLocal.pauli "qiskit.circuit.library.TwoLocal.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
  ...
  | [`qasm`](#qiskit.circuit.library.TwoLocal.qasm "qiskit.circuit.library.TwoLocal.qasm")(\[formatted, filename, encoding])                                                                  | Return OpenQASM string.                                                                                                             |
  ...
  | [`to_instruction`](#qiskit.circuit.library.TwoLocal.to_instruction "qiskit.circuit.library.TwoLocal.to_instruction")(\[parameter\_map, label])                                            | Create an Instruction out of this circuit.                                                                                          |
  ...
  <Function id="qiskit.circuit.library.TwoLocal.ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False, wrap=False)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.TwoLocal\_0\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.TwoLocal_0_0.png) ![../\_images/qiskit.circuit.library.TwoLocal\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.TwoLocal_0_1.png)
  </Function>
  ...
  <Function id="qiskit.circuit.library.TwoLocal.get_instructions" signature="get_instructions(name)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.TwoLocal.qasm" signature="qasm(formatted=False, filename=None, encoding=None)">
  ...
  <Function id="qiskit.circuit.library.TwoLocal.to_instruction" signature="to_instruction(parameter_map=None, label=None)">
