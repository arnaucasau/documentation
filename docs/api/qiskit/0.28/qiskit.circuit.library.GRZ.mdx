...
$$
  ...
  **Expanded Circuit:**
  ...
  ![../\_images/qiskit.circuit.library.GRZ\_0\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.GRZ_0_1.png)
  ...
  *   **phi** (`float`) – rotation angle about z-axis
  ...
  | [`compose`](#qiskit.circuit.library.GRZ.compose "qiskit.circuit.library.GRZ.compose")(other\[, qubits, clbits, front, …])                                                       | Compose circuit with `other` circuit or instruction, optionally permuting wires.                                                    |
  ...
  | [`get_instructions`](#qiskit.circuit.library.GRZ.get_instructions "qiskit.circuit.library.GRZ.get_instructions")(name)                                                          | Get instructions matching name.                                                                                                     |
  ...
  | [`pauli`](#qiskit.circuit.library.GRZ.pauli "qiskit.circuit.library.GRZ.pauli")(pauli\_string, qubits)                                                                          | Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").                                           |
  ...
  | [`qasm`](#qiskit.circuit.library.GRZ.qasm "qiskit.circuit.library.GRZ.qasm")(\[formatted, filename, encoding])                                                                  | Return OpenQASM string.                                                                                                             |
  ...
  | [`to_instruction`](#qiskit.circuit.library.GRZ.to_instruction "qiskit.circuit.library.GRZ.to_instruction")(\[parameter\_map, label])                                            | Create an Instruction out of this circuit.                                                                                          |
  ...
  <Function id="qiskit.circuit.library.GRZ.ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.GRZ.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False, wrap=False)">
  ...
  <Function id="qiskit.circuit.library.GRZ.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.GRZ\_3\_0.png](/images/api/qiskit/0.28/qiskit.circuit.library.GRZ_3_0.png) ![../\_images/qiskit.circuit.library.GRZ\_3\_1.png](/images/api/qiskit/0.28/qiskit.circuit.library.GRZ_3_1.png)
  </Function>
  ...
  <Function id="qiskit.circuit.library.GRZ.get_instructions" signature="get_instructions(name)">
  ...
  <Function id="qiskit.circuit.library.GRZ.iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
  ...
  <Function id="qiskit.circuit.library.GRZ.isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.GRZ.qasm" signature="qasm(formatted=False, filename=None, encoding=None)">
  ...
  <Function id="qiskit.circuit.library.GRZ.to_instruction" signature="to_instruction(parameter_map=None, label=None)">
