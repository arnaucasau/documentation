...
<Class id="qiskit.providers.aer.library.SetStatevector" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-aer/tree/stable/0.8/qiskit/providers/aer/library/set_instructions/set_statevector.py" signature="SetStatevector(state)" modifiers="class">
  ...
  **ExtensionError** – if the input is not a valid state.
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.__init__" signature="__init__(state)">
    Create new instruction to set the statevector state of the simulator.
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.add_decomposition" signature="add_decomposition(decomposition)">
    Add a decomposition of the instruction to the SessionEquivalenceLibrary.
  </Function>

  ### assemble

  <Function id="qiskit.providers.aer.library.SetStatevector.assemble" signature="assemble()">
    Assemble a QasmQobjInstruction
  </Function>

  ### broadcast\_arguments

  <Function id="qiskit.providers.aer.library.SetStatevector.broadcast_arguments" signature="broadcast_arguments(qargs, cargs)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.c_if" signature="c_if(classical, val)">
    Add classical condition on register or cbit classical and value val.
  </Function>

  ### copy

  <Function id="qiskit.providers.aer.library.SetStatevector.copy" signature="copy(name=None)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.inverse" signature="inverse()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.is_parameterized" signature="is_parameterized()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.mirror" signature="mirror()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.qasm" signature="qasm()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.repeat" signature="repeat(n)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.soft_compare" signature="soft_compare(other)">
  ...
  <Function id="qiskit.providers.aer.library.SetStatevector.validate_parameter" signature="validate_parameter(parameter)">
