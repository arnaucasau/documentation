...
$$
  ...
  *   **name** (`str`) – The name of the circuit object.
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False, wrap=False)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.get_instructions" signature="get_instructions(name)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.qasm" signature="qasm(formatted=False, filename=None, encoding=None)">
  ...
  <Function id="qiskit.circuit.library.LinearPauliRotations.to_instruction" signature="to_instruction(parameter_map=None, label=None)">
