...
<Class id="qiskit.circuit.library.EvolvedOperatorAnsatz" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.18/qiskit/circuit/library/evolved_operator_ansatz.py" signature="EvolvedOperatorAnsatz(operators=None, reps=1, evolution=None, insert_barriers=False, name='EvolvedOps', initial_state=None)" modifiers="class">
  ...
  *   **initial\_state** (`Optional`\[`QuantumCircuit`]) – A QuantumCircuit object to prepend to the circuit.
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.__init__" signature="__init__(operators=None, reps=1, evolution=None, insert_barriers=False, name='EvolvedOps', initial_state=None)">
    **Parameters**
  ...
  |                                                                                                                                                                                                                     |                                                                                                                                     |
  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
  | [`__init__`](#qiskit.circuit.library.EvolvedOperatorAnsatz.__init__ "qiskit.circuit.library.EvolvedOperatorAnsatz.__init__")(\[operators, reps, evolution, …])                                                      | **param operators**The operators to evolve.                                                                                         |
  | [`add_bits`](#qiskit.circuit.library.EvolvedOperatorAnsatz.add_bits "qiskit.circuit.library.EvolvedOperatorAnsatz.add_bits")(bits)                                                                                  | Add Bits to the circuit.                                                                                                            |
  | [`add_calibration`](#qiskit.circuit.library.EvolvedOperatorAnsatz.add_calibration "qiskit.circuit.library.EvolvedOperatorAnsatz.add_calibration")(gate, qubits, schedule\[, params])                                | Register a low-level, custom pulse definition for the given gate.                                                                   |
  | [`add_register`](#qiskit.circuit.library.EvolvedOperatorAnsatz.add_register "qiskit.circuit.library.EvolvedOperatorAnsatz.add_register")(\*regs)                                                                    | Add registers.                                                                                                                      |
  | [`append`](#qiskit.circuit.library.EvolvedOperatorAnsatz.append "qiskit.circuit.library.EvolvedOperatorAnsatz.append")(instruction\[, qargs, cargs])                                                                | Append one or more instructions to the end of the circuit, modifying the circuit in place.                                          |
  | [`assign_parameters`](#qiskit.circuit.library.EvolvedOperatorAnsatz.assign_parameters "qiskit.circuit.library.EvolvedOperatorAnsatz.assign_parameters")(parameters\[, inplace, …])                                  | Assign parameters to new parameters or values.                                                                                      |
  | [`barrier`](#qiskit.circuit.library.EvolvedOperatorAnsatz.barrier "qiskit.circuit.library.EvolvedOperatorAnsatz.barrier")(\*qargs)                                                                                  | Apply `Barrier`.                                                                                                                    |
  ...
  | [`save_expectation_value`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_expectation_value "qiskit.circuit.library.EvolvedOperatorAnsatz.save_expectation_value")(operator, qubits\[, …])                      | Save the expectation value of a Hermitian operator.                                                                                 |
  | [`save_expectation_value_variance`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_expectation_value_variance "qiskit.circuit.library.EvolvedOperatorAnsatz.save_expectation_value_variance")(operator, qubits) | Save the expectation value of a Hermitian operator.                                                                                 |
  | [`save_matrix_product_state`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_matrix_product_state "qiskit.circuit.library.EvolvedOperatorAnsatz.save_matrix_product_state")(\[label, pershot, …])               | Save the current simulator quantum state as a matrix product state.                                                                 |
  | [`save_probabilities`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_probabilities "qiskit.circuit.library.EvolvedOperatorAnsatz.save_probabilities")(\[qubits, label, …])                                     | Save measurement outcome probabilities vector.                                                                                      |
  | [`save_probabilities_dict`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_probabilities_dict "qiskit.circuit.library.EvolvedOperatorAnsatz.save_probabilities_dict")(\[qubits, label, …])                      | Save measurement outcome probabilities vector.                                                                                      |
  | [`save_stabilizer`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_stabilizer "qiskit.circuit.library.EvolvedOperatorAnsatz.save_stabilizer")(\[label, pershot, conditional])                                   | Save the current stabilizer simulator quantum state as a Clifford.                                                                  |
  | [`save_state`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_state "qiskit.circuit.library.EvolvedOperatorAnsatz.save_state")(\[label, pershot, conditional])                                                  | Save the current simulator quantum state.                                                                                           |
  | [`save_statevector`](#qiskit.circuit.library.EvolvedOperatorAnsatz.save_statevector "qiskit.circuit.library.EvolvedOperatorAnsatz.save_statevector")(\[label, pershot, conditional])                                | Save the current simulator quantum state as a statevector.                                                                          |
  ...
  | [`set_statevector`](#qiskit.circuit.library.EvolvedOperatorAnsatz.set_statevector "qiskit.circuit.library.EvolvedOperatorAnsatz.set_statevector")(state)                                                            | Set the statevector state of the simulator.                                                                                         |
  | [`set_superop`](#qiskit.circuit.library.EvolvedOperatorAnsatz.set_superop "qiskit.circuit.library.EvolvedOperatorAnsatz.set_superop")(state)                                                                        | Set the superop state of the simulator.                                                                                             |
  | [`set_unitary`](#qiskit.circuit.library.EvolvedOperatorAnsatz.set_unitary "qiskit.circuit.library.EvolvedOperatorAnsatz.set_unitary")(state)                                                                        | Set the state state of the simulator.                                                                                               |
  | [`size`](#qiskit.circuit.library.EvolvedOperatorAnsatz.size "qiskit.circuit.library.EvolvedOperatorAnsatz.size")()                                                                                                  | Returns total number of gate operations in circuit.                                                                                 |
  | [`snapshot`](#qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot "qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot")(label\[, snapshot\_type, qubits, params])                                              | Take a statevector snapshot of the internal simulator representation.                                                               |
  | [`snapshot_density_matrix`](#qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_density_matrix "qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_density_matrix")(label\[, qubits])                         | Take a density matrix snapshot of simulator state.                                                                                  |
  | [`snapshot_expectation_value`](#qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_expectation_value "qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_expectation_value")(label, op, qubits)               | Take a snapshot of expectation value \<O> of an Operator.                                                                           |
  | [`snapshot_probabilities`](#qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_probabilities "qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_probabilities")(label, qubits\[, variance])                  | Take a probability snapshot of the simulator state.                                                                                 |
  ...
  |                                                                                                                                                                     |                                                                              |
  | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
  | [`ancillas`](#qiskit.circuit.library.EvolvedOperatorAnsatz.ancillas "qiskit.circuit.library.EvolvedOperatorAnsatz.ancillas")                                        | Returns a list of ancilla bits in the order that the registers were added.   |
  | [`calibrations`](#qiskit.circuit.library.EvolvedOperatorAnsatz.calibrations "qiskit.circuit.library.EvolvedOperatorAnsatz.calibrations")                            | Return calibration dictionary.                                               |
  | [`clbits`](#qiskit.circuit.library.EvolvedOperatorAnsatz.clbits "qiskit.circuit.library.EvolvedOperatorAnsatz.clbits")                                              | Returns a list of classical bits in the order that the registers were added. |
  | [`data`](#qiskit.circuit.library.EvolvedOperatorAnsatz.data "qiskit.circuit.library.EvolvedOperatorAnsatz.data")                                                    | Return the circuit data (instructions and context).                          |
  | [`evolution`](#qiskit.circuit.library.EvolvedOperatorAnsatz.evolution "qiskit.circuit.library.EvolvedOperatorAnsatz.evolution")                                     | The evolution converter used to compute the evolution.                       |
  | `extension_lib`                                                                                                                                                     |                                                                              |
  | [`global_phase`](#qiskit.circuit.library.EvolvedOperatorAnsatz.global_phase "qiskit.circuit.library.EvolvedOperatorAnsatz.global_phase")                            | Return the global phase of the circuit in radians.                           |
  | `header`                                                                                                                                                            |                                                                              |
  | [`initial_state`](#qiskit.circuit.library.EvolvedOperatorAnsatz.initial_state "qiskit.circuit.library.EvolvedOperatorAnsatz.initial_state")                         | The initial state.                                                           |
  | `instances`                                                                                                                                                         |                                                                              |
  | [`metadata`](#qiskit.circuit.library.EvolvedOperatorAnsatz.metadata "qiskit.circuit.library.EvolvedOperatorAnsatz.metadata")                                        | The user provided metadata associated with the circuit                       |
  | [`num_ancillas`](#qiskit.circuit.library.EvolvedOperatorAnsatz.num_ancillas "qiskit.circuit.library.EvolvedOperatorAnsatz.num_ancillas")                            | Return the number of ancilla qubits.                                         |
  | [`num_clbits`](#qiskit.circuit.library.EvolvedOperatorAnsatz.num_clbits "qiskit.circuit.library.EvolvedOperatorAnsatz.num_clbits")                                  | Return number of classical bits.                                             |
  | [`num_parameters`](#qiskit.circuit.library.EvolvedOperatorAnsatz.num_parameters "qiskit.circuit.library.EvolvedOperatorAnsatz.num_parameters")                      | Convenience function to get the number of parameter objects in the circuit.  |
  | [`num_qubits`](#qiskit.circuit.library.EvolvedOperatorAnsatz.num_qubits "qiskit.circuit.library.EvolvedOperatorAnsatz.num_qubits")                                  | Return number of qubits.                                                     |
  | [`operators`](#qiskit.circuit.library.EvolvedOperatorAnsatz.operators "qiskit.circuit.library.EvolvedOperatorAnsatz.operators")                                     | The operators that are evolved in this circuit.                              |
  | [`parameters`](#qiskit.circuit.library.EvolvedOperatorAnsatz.parameters "qiskit.circuit.library.EvolvedOperatorAnsatz.parameters")                                  | Convenience function to get the parameters defined in the parameter table.   |
  | [`preferred_init_points`](#qiskit.circuit.library.EvolvedOperatorAnsatz.preferred_init_points "qiskit.circuit.library.EvolvedOperatorAnsatz.preferred_init_points") | Getter of preferred initial points based on the given initial state.         |
  | `prefix`                                                                                                                                                            |                                                                              |
  | [`qregs`](#qiskit.circuit.library.EvolvedOperatorAnsatz.qregs "qiskit.circuit.library.EvolvedOperatorAnsatz.qregs")                                                 | A list of the quantum registers associated with the circuit.                 |
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.add_bits" signature="add_bits(bits)">
    Add Bits to the circuit.
  </Function>

  ### add\_calibration

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.add_calibration" signature="add_calibration(gate, qubits, schedule, params=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.add_register" signature="add_register(*regs)">
    Add registers.
  </Function>
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.append" signature="append(instruction, qargs=None, cargs=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.assign_parameters" signature="assign_parameters(parameters, inplace=False, param_dict=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.barrier" signature="barrier(*qargs)">
    Apply `Barrier`. If qargs is None, applies to all.
  </Function>

  ### bind\_parameters

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.bind_parameters" signature="bind_parameters(values, value_dict=None)">
    Assign numeric parameters to values yielding a new circuit.

    To assign new Parameter objects or bind the values in-place, without yielding a new circuit, use the [`assign_parameters()`](#qiskit.circuit.library.EvolvedOperatorAnsatz.assign_parameters "qiskit.circuit.library.EvolvedOperatorAnsatz.assign_parameters") method.
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cast" signature="cast(value, _type)" modifiers="static">
    Best effort to cast value to type. Otherwise, returns the value.
  </Function>

  ### cbit\_argument\_conversion

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cbit_argument_conversion" signature="cbit_argument_conversion(clbit_representation)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ccx" signature="ccx(control_qubit1, control_qubit2, target_qubit, ctrl_state=None)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### ch

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ch" signature="ch(control_qubit, target_qubit, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cls_instances" signature="cls_instances()" modifiers="classmethod">
    Return the current number of instances of this class, useful for auto naming.
  </Function>

  ### cls\_prefix

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cls_prefix" signature="cls_prefix()" modifiers="classmethod">
    Return the prefix to use for auto naming.
  </Function>

  ### cnot

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cnot" signature="cnot(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### combine

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.combine" signature="combine(rhs)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.compose" signature="compose(other, qubits=None, clbits=None, front=False, inplace=False, wrap=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.control" signature="control(num_ctrl_qubits=1, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.copy" signature="copy(name=None)">
    Copy the circuit.
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.count_ops" signature="count_ops()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cp" signature="cp(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CPhaseGate`](qiskit.circuit.library.CPhaseGate "qiskit.circuit.library.CPhaseGate").
  </Function>

  ### crx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.crx" signature="crx(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRXGate`](qiskit.circuit.library.CRXGate "qiskit.circuit.library.CRXGate").
  </Function>

  ### cry

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cry" signature="cry(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRYGate`](qiskit.circuit.library.CRYGate "qiskit.circuit.library.CRYGate").
  </Function>

  ### crz

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.crz" signature="crz(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CRZGate`](qiskit.circuit.library.CRZGate "qiskit.circuit.library.CRZGate").
  </Function>

  ### cswap

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cswap" signature="cswap(control_qubit, target_qubit1, target_qubit2, label=None, ctrl_state=None)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### csx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.csx" signature="csx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CSXGate`](qiskit.circuit.library.CSXGate "qiskit.circuit.library.CSXGate").
  </Function>

  ### cu

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cu" signature="cu(theta, phi, lam, gamma, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CUGate`](qiskit.circuit.library.CUGate "qiskit.circuit.library.CUGate").
  </Function>

  ### cu1

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cu1" signature="cu1(theta, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU1Gate`](qiskit.circuit.library.CU1Gate "qiskit.circuit.library.CU1Gate").
  </Function>

  ### cu3

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cu3" signature="cu3(theta, phi, lam, control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CU3Gate`](qiskit.circuit.library.CU3Gate "qiskit.circuit.library.CU3Gate").
  </Function>

  ### cx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cx" signature="cx(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate").
  </Function>

  ### cy

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cy" signature="cy(control_qubit, target_qubit, label=None, ctrl_state=None)">
    Apply [`CYGate`](qiskit.circuit.library.CYGate "qiskit.circuit.library.CYGate").
  </Function>

  ### cz

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.cz" signature="cz(control_qubit, target_qubit, label=None, ctrl_state=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.dcx" signature="dcx(qubit1, qubit2)">
    Apply [`DCXGate`](qiskit.circuit.library.DCXGate "qiskit.circuit.library.DCXGate").
  </Function>

  ### decompose

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.decompose" signature="decompose()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.delay" signature="delay(duration, qarg=None, unit='dt')">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.depth" signature="depth()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.diagonal" signature="diagonal(diag, qubit)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ecr" signature="ecr(qubit1, qubit2)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.extend" signature="extend(rhs)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.fredkin" signature="fredkin(control_qubit, target_qubit1, target_qubit2)">
    Apply [`CSwapGate`](qiskit.circuit.library.CSwapGate "qiskit.circuit.library.CSwapGate").
  </Function>

  ### from\_qasm\_file

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.from_qasm_file" signature="from_qasm_file(path)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.from_qasm_str" signature="from_qasm_str(qasm_str)" modifiers="static">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.get_instructions" signature="get_instructions(name)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.h" signature="h(qubit)">
    Apply [`HGate`](qiskit.circuit.library.HGate "qiskit.circuit.library.HGate").
  </Function>

  ### hamiltonian

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.hamiltonian" signature="hamiltonian(operator, time, qubits, label=None)">
    Apply hamiltonian evolution to qubits.
  </Function>

  ### has\_register

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.has_register" signature="has_register(register)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.i" signature="i(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>

  ### id

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.id" signature="id(qubit)">
    Apply [`IGate`](qiskit.circuit.library.IGate "qiskit.circuit.library.IGate").
  </Function>
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.initialize" signature="initialize(params, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.inverse" signature="inverse()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.iso" signature="iso(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.isometry" signature="isometry(isometry, q_input, q_ancillas_for_output, q_ancillas_zero=None, q_ancillas_dirty=None, epsilon=1e-10)">
    Attach an arbitrary isometry from m to n qubits to a circuit. In particular, this allows to attach arbitrary unitaries on n qubits (m=n) or to prepare any state on n qubits (m=0). The decomposition used here was introduced by Iten et al. in [https://arxiv.org/abs/1501.06911](https://arxiv.org/abs/1501.06911).
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.iswap" signature="iswap(qubit1, qubit2)">
    Apply [`iSwapGate`](qiskit.circuit.library.iSwapGate "qiskit.circuit.library.iSwapGate").
  </Function>

  ### mcp

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mcp" signature="mcp(lam, control_qubits, target_qubit)">
    Apply [`MCPhaseGate`](qiskit.circuit.library.MCPhaseGate "qiskit.circuit.library.MCPhaseGate").
  </Function>

  ### mcrx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mcrx" signature="mcrx(theta, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mcry" signature="mcry(theta, q_controls, q_target, q_ancillae=None, mode=None, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mcrz" signature="mcrz(lam, q_controls, q_target, use_basis_gates=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mct" signature="mct(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  </Function>

  ### mcu1

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mcu1" signature="mcu1(lam, control_qubits, target_qubit)">
    Apply `MCU1Gate`.
  </Function>

  ### mcx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.mcx" signature="mcx(control_qubits, target_qubit, ancilla_qubits=None, mode='noancilla')">
    Apply [`MCXGate`](qiskit.circuit.library.MCXGate "qiskit.circuit.library.MCXGate").
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.measure" signature="measure(qubit, cbit)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.measure_active" signature="measure_active(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.measure_all" signature="measure_all(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ms" signature="ms(theta, qubits)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.num_connected_components" signature="num_connected_components(unitary_only=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.num_nonlocal_gates" signature="num_nonlocal_gates()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.num_tensor_factors" signature="num_tensor_factors()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.num_unitary_factors" signature="num_unitary_factors()">
    Computes the number of tensor factors in the unitary (quantum) part of the circuit only.
  </Function>
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.p" signature="p(theta, qubit)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.pauli" signature="pauli(pauli_string, qubits)">
    Apply [`PauliGate`](qiskit.circuit.library.PauliGate "qiskit.circuit.library.PauliGate").
  </Function>

  ### power

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.power" signature="power(power, matrix_power=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.qasm" signature="qasm(formatted=False, filename=None, encoding=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.qbit_argument_conversion" signature="qbit_argument_conversion(qubit_representation)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.qubit_duration" signature="qubit_duration(*qubits)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.qubit_start_time" signature="qubit_start_time(*qubits)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.qubit_stop_time" signature="qubit_stop_time(*qubits)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.r" signature="r(theta, phi, qubit)">
    Apply [`RGate`](qiskit.circuit.library.RGate "qiskit.circuit.library.RGate").
  </Function>

  ### rcccx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rcccx" signature="rcccx(control_qubit1, control_qubit2, control_qubit3, target_qubit)">
    Apply [`RC3XGate`](qiskit.circuit.library.RC3XGate "qiskit.circuit.library.RC3XGate").
  </Function>

  ### rccx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rccx" signature="rccx(control_qubit1, control_qubit2, target_qubit)">
    Apply [`RCCXGate`](qiskit.circuit.library.RCCXGate "qiskit.circuit.library.RCCXGate").
  </Function>

  ### remove\_final\_measurements

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.remove_final_measurements" signature="remove_final_measurements(inplace=True)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.repeat" signature="repeat(reps)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.reset" signature="reset(qubit)">
    Reset q.
  </Function>

  ### reverse\_bits

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.reverse_bits" signature="reverse_bits()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.reverse_ops" signature="reverse_ops()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rv" signature="rv(vx, vy, vz, qubit)">
    Apply [`RVGate`](qiskit.circuit.library.RVGate "qiskit.circuit.library.RVGate").
  </Function>

  ### rx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rx" signature="rx(theta, qubit, label=None)">
    Apply [`RXGate`](qiskit.circuit.library.RXGate "qiskit.circuit.library.RXGate").
  </Function>

  ### rxx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rxx" signature="rxx(theta, qubit1, qubit2)">
    Apply [`RXXGate`](qiskit.circuit.library.RXXGate "qiskit.circuit.library.RXXGate").
  </Function>

  ### ry

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ry" signature="ry(theta, qubit, label=None)">
    Apply [`RYGate`](qiskit.circuit.library.RYGate "qiskit.circuit.library.RYGate").
  </Function>

  ### ryy

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ryy" signature="ryy(theta, qubit1, qubit2)">
    Apply [`RYYGate`](qiskit.circuit.library.RYYGate "qiskit.circuit.library.RYYGate").
  </Function>

  ### rz

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rz" signature="rz(phi, qubit)">
    Apply [`RZGate`](qiskit.circuit.library.RZGate "qiskit.circuit.library.RZGate").
  </Function>

  ### rzx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rzx" signature="rzx(theta, qubit1, qubit2)">
    Apply [`RZXGate`](qiskit.circuit.library.RZXGate "qiskit.circuit.library.RZXGate").
  </Function>

  ### rzz

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.rzz" signature="rzz(theta, qubit1, qubit2)">
    Apply [`RZZGate`](qiskit.circuit.library.RZZGate "qiskit.circuit.library.RZZGate").
  </Function>

  ### s

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.s" signature="s(qubit)">
    Apply [`SGate`](qiskit.circuit.library.SGate "qiskit.circuit.library.SGate").
  </Function>

  ### save\_amplitudes

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_amplitudes" signature="save_amplitudes(params, label='amplitudes', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_amplitudes_squared" signature="save_amplitudes_squared(params, label='amplitudes_squared', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_density_matrix" signature="save_density_matrix(qubits=None, label='density_matrix', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_expectation_value" signature="save_expectation_value(operator, qubits, label='expectation_value', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_expectation_value_variance" signature="save_expectation_value_variance(operator, qubits, label='expectation_value_variance', unnormalized=False, pershot=False, conditional=False)">
    Save the expectation value of a Hermitian operator.
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_matrix_product_state" signature="save_matrix_product_state(label='matrix_product_state', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_probabilities" signature="save_probabilities(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_probabilities_dict" signature="save_probabilities_dict(qubits=None, label='probabilities', unnormalized=False, pershot=False, conditional=False)">
    Save measurement outcome probabilities vector.
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_stabilizer" signature="save_stabilizer(label='stabilizer', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_state" signature="save_state(label=None, pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_statevector" signature="save_statevector(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_statevector_dict" signature="save_statevector_dict(label='statevector', pershot=False, conditional=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_superop" signature="save_superop(label='superop', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.save_unitary" signature="save_unitary(label='unitary', pershot=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.sdg" signature="sdg(qubit)">
    Apply [`SdgGate`](qiskit.circuit.library.SdgGate "qiskit.circuit.library.SdgGate").
  </Function>

  ### set\_density\_matrix

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.set_density_matrix" signature="set_density_matrix(state)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.set_matrix_product_state" signature="set_matrix_product_state(state)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.set_stabilizer" signature="set_stabilizer(state)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.set_statevector" signature="set_statevector(state)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.set_superop" signature="set_superop(state)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.set_unitary" signature="set_unitary(state)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.size" signature="size()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot" signature="snapshot(label, snapshot_type='statevector', qubits=None, params=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_density_matrix" signature="snapshot_density_matrix(label, qubits=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_expectation_value" signature="snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_probabilities" signature="snapshot_probabilities(label, qubits, variance=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_stabilizer" signature="snapshot_stabilizer(label)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.snapshot_statevector" signature="snapshot_statevector(label)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.squ" signature="squ(unitary_matrix, qubit, mode='ZYZ', up_to_diagonal=False, *, u=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.swap" signature="swap(qubit1, qubit2)">
    Apply [`SwapGate`](qiskit.circuit.library.SwapGate "qiskit.circuit.library.SwapGate").
  </Function>

  ### sx

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.sx" signature="sx(qubit)">
    Apply [`SXGate`](qiskit.circuit.library.SXGate "qiskit.circuit.library.SXGate").
  </Function>

  ### sxdg

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.sxdg" signature="sxdg(qubit)">
    Apply [`SXdgGate`](qiskit.circuit.library.SXdgGate "qiskit.circuit.library.SXdgGate").
  </Function>

  ### t

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.t" signature="t(qubit)">
    Apply [`TGate`](qiskit.circuit.library.TGate "qiskit.circuit.library.TGate").
  </Function>

  ### tdg

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.tdg" signature="tdg(qubit)">
    Apply [`TdgGate`](qiskit.circuit.library.TdgGate "qiskit.circuit.library.TdgGate").
  </Function>

  ### tensor

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.tensor" signature="tensor(other, inplace=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.to_gate" signature="to_gate(parameter_map=None, label=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.to_instruction" signature="to_instruction(parameter_map=None, label=None)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.toffoli" signature="toffoli(control_qubit1, control_qubit2, target_qubit)">
    Apply [`CCXGate`](qiskit.circuit.library.CCXGate "qiskit.circuit.library.CCXGate").
  </Function>

  ### u

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.u" signature="u(theta, phi, lam, qubit)">
    Apply [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate").
  </Function>

  ### u1

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.u1" signature="u1(theta, qubit)">
    Apply [`U1Gate`](qiskit.circuit.library.U1Gate "qiskit.circuit.library.U1Gate").
  </Function>

  ### u2

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.u2" signature="u2(phi, lam, qubit)">
    Apply [`U2Gate`](qiskit.circuit.library.U2Gate "qiskit.circuit.library.U2Gate").
  </Function>

  ### u3

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.u3" signature="u3(theta, phi, lam, qubit)">
    Apply [`U3Gate`](qiskit.circuit.library.U3Gate "qiskit.circuit.library.U3Gate").
  </Function>

  ### uc

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.uc" signature="uc(gate_list, q_controls, q_target, up_to_diagonal=False)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ucrx" signature="ucrx(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ucry" signature="ucry(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.ucrz" signature="ucrz(angle_list, q_controls, q_target)">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.unitary" signature="unitary(obj, qubits, label=None)">
    Apply unitary gate to q.
  </Function>

  ### width

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.width" signature="width()">
  ...
  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.x" signature="x(qubit, label=None)">
    Apply [`XGate`](qiskit.circuit.library.XGate "qiskit.circuit.library.XGate").
  </Function>

  ### y

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.y" signature="y(qubit)">
    Apply [`YGate`](qiskit.circuit.library.YGate "qiskit.circuit.library.YGate").
  </Function>

  ### z

  <Function id="qiskit.circuit.library.EvolvedOperatorAnsatz.z" signature="z(qubit)">
