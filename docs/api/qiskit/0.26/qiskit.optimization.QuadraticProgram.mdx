...
<Class id="qiskit.optimization.QuadraticProgram" isDedicatedPage={true} github="https://github.com/qiskit-community/qiskit-aqua/tree/stable/0.9/qiskit/optimization/problems/quadratic_program.py" signature="QuadraticProgram(name='')" modifiers="class">
  ...
  **name** (`str`) – The name of the quadratic program.
  ...
  <Function id="qiskit.optimization.QuadraticProgram.binary_var_dict" signature="binary_var_dict(keys, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.binary_var_list" signature="binary_var_list(keys, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.continuous_var_dict" signature="continuous_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.continuous_var_list" signature="continuous_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.integer_var_dict" signature="integer_var_dict(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
  ...
  <Function id="qiskit.optimization.QuadraticProgram.integer_var_list" signature="integer_var_list(keys, lowerbound=0, upperbound=1e+20, name=None, key_format='{}')">
