  ...
  *   **name** (`str`) – The name of the circuit.
  ...
  <Function id="qiskit.circuit.library.PiecewiseLinearPauliRotations.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.PiecewiseLinearPauliRotations\_2\_0.png](/images/api/qiskit/0.26/qiskit.circuit.library.PiecewiseLinearPauliRotations_2_0.png)
  </Function>
