...
<Class id="qiskit.circuit.library.U1Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/u1.py" signature="U1Gate(theta, label=None)" modifiers="class">
...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.U1Gate.soft_compare" signature="soft_compare(other)">
