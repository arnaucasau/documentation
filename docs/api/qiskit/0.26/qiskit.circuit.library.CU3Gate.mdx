...
<Class id="qiskit.circuit.library.CU3Gate" isDedicatedPage={true} github="https://github.com/qiskit/qiskit/tree/stable/0.17/qiskit/circuit/library/standard_gates/u3.py" signature="CU3Gate(theta, phi, lam, label=None, ctrl_state=None)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.CU3Gate.soft_compare" signature="soft_compare(other)">
