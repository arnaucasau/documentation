...
<Class id="qiskit.providers.ibmq.AccountProvider" isDedicatedPage={true} github="https://github.com/qiskit/qiskit-ibmq-provider/tree/stable/0.14/qiskit/providers/ibmq/accountprovider.py" signature="AccountProvider(credentials, factory)" modifiers="class">
