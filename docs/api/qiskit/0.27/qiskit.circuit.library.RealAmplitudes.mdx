  ...
  *   **insert\_barriers** (`bool`) – If True, barriers are inserted in between each layer. If False, no barriers are inserted.
  ...
  <Function id="qiskit.circuit.library.RealAmplitudes.draw" signature="draw(output=None, scale=None, filename=None, style=None, interactive=False, plot_barriers=True, reverse_bits=False, justify=None, vertical_compression='medium', idle_wires=True, with_layout=True, fold=None, ax=None, initial_state=False, cregbundle=True)">
    ...
    **Example**
    ...
    ![../\_images/qiskit.circuit.library.RealAmplitudes\_0\_0.png](/images/api/qiskit/0.27/qiskit.circuit.library.RealAmplitudes_0_0.png) ![../\_images/qiskit.circuit.library.RealAmplitudes\_0\_1.png](/images/api/qiskit/0.27/qiskit.circuit.library.RealAmplitudes_0_1.png)
  </Function>
