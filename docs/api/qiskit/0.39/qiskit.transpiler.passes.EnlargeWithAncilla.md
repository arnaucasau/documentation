...
`EnlargeWithAncilla(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py "view source code")
...
`EnlargeWithAncilla.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/layout/enlarge_with_ancilla.py "view source code")
