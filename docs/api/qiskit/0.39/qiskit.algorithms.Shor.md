...
`Shor(quantum_instance=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/factorizers/shor.py "view source code")
...
`Shor.construct_circuit(N, a=2, measurement=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/factorizers/shor.py "view source code")
...
`Shor.factor(N, a=2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/factorizers/shor.py "view source code")
...
`static Shor.modinv(a, m)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/factorizers/shor.py "view source code")
