...
`BaseReadoutMitigator`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/base_readout_mitigator.py "view source code")
...
`abstract BaseReadoutMitigator.expectation_value(data, diagonal, qubits=None, clbits=None, shots=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/base_readout_mitigator.py "view source code")
...
`abstract BaseReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/base_readout_mitigator.py "view source code")
