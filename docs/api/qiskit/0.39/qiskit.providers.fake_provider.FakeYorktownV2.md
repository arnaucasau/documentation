...
`FakeYorktownV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/yorktown/fake_yorktown.py "view source code")
