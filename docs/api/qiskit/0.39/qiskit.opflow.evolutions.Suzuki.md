...
`Suzuki(reps=1, order=2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/evolutions/trotterizations/suzuki.py "view source code")
...
`Suzuki.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/evolutions/trotterizations/suzuki.py "view source code")
