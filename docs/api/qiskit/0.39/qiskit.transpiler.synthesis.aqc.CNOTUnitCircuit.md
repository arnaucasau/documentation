...
`CNOTUnitCircuit(num_qubits, cnots, tol=0.0, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/synthesis/aqc/cnot_unit_circuit.py "view source code")
...
`CNOTUnitCircuit.build(thetas)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/synthesis/aqc/cnot_unit_circuit.py "view source code")
