...
`BackendSampler(backend, options=None, bound_pass_manager=None, skip_transpilation=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/backend_sampler.py "view source code")
...
`BackendSampler.set_transpile_options(**fields)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/backend_sampler.py "view source code")
