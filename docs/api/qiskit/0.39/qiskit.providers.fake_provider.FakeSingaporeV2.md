...
`FakeSingaporeV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/singapore/fake_singapore.py "view source code")
