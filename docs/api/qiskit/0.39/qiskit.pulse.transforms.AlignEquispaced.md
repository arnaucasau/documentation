...
`AlignEquispaced(duration)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/transforms/alignments.py "view source code")
...
`AlignEquispaced.align(schedule)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/transforms/alignments.py "view source code")
...
`AlignEquispaced.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/transforms/alignments.py "view source code")
