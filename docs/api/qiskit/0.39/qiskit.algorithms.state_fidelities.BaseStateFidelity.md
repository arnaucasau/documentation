...
`BaseStateFidelity`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/state_fidelities/base_state_fidelity.py "view source code")
...
`abstract BaseStateFidelity.create_fidelity_circuit(circuit_1, circuit_2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/state_fidelities/base_state_fidelity.py "view source code")
...
`BaseStateFidelity.run(circuits_1, circuits_2, values_1=None, values_2=None, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/state_fidelities/base_state_fidelity.py "view source code")
