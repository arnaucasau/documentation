...
`FakeOpenPulse3Q`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/fake_openpulse_3q.py "view source code")
...
`FakeOpenPulse3Q.defaults()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/fake_openpulse_3q.py "view source code")
