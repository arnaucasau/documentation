...
`FakeRueschlikon`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/rueschlikon/fake_rueschlikon.py "view source code")
