...
`CVaRExpectation(alpha, expectation=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/expectations/cvar_expectation.py "view source code")
...
`CVaRExpectation.compute_variance(exp_op)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/expectations/cvar_expectation.py "view source code")
...
`CVaRExpectation.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/expectations/cvar_expectation.py "view source code")
