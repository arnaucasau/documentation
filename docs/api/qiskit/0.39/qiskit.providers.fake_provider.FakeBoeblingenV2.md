...
`FakeBoeblingenV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/boeblingen/fake_boeblingen.py "view source code")
