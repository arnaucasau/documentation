...
`InverseCancellation(gates_to_cancel)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/inverse_cancellation.py "view source code")
...
`InverseCancellation.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/inverse_cancellation.py "view source code")
