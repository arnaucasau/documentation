...
`CorrelatedReadoutMitigator(assignment_matrix, qubits=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/correlated_readout_mitigator.py "view source code")
...
`CorrelatedReadoutMitigator.expectation_value(data, diagonal=None, qubits=None, clbits=None, shots=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/correlated_readout_mitigator.py "view source code")
...
`CorrelatedReadoutMitigator.mitigation_matrix(qubits=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/correlated_readout_mitigator.py "view source code")
...
`CorrelatedReadoutMitigator.quasi_probabilities(data, qubits=None, clbits=None, shots=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/correlated_readout_mitigator.py "view source code")
...
`CorrelatedReadoutMitigator.stddev_upper_bound(shots)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/result/mitigation/correlated_readout_mitigator.py "view source code")
