...
`QobjMeasurementOption(name, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/qobj/pulse_qobj.py "view source code")
...
`classmethod QobjMeasurementOption.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/qobj/pulse_qobj.py "view source code")
...
`QobjMeasurementOption.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/qobj/pulse_qobj.py "view source code")
