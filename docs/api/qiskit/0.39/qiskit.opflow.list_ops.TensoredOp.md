...
`TensoredOp(oplist, coeff=1.0, abelian=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/list_ops/tensored_op.py "view source code")
...
`TensoredOp.eval(front=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/list_ops/tensored_op.py "view source code")
...
`TensoredOp.reduce()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/list_ops/tensored_op.py "view source code")
...
`TensoredOp.tensor(other)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/list_ops/tensored_op.py "view source code")
...
`TensoredOp.to_circuit()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/list_ops/tensored_op.py "view source code")
