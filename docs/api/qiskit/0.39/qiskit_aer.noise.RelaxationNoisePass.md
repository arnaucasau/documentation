...
`RelaxationNoisePass(t1s, t2s, dt=None, op_types=None, excited_state_populations=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/noise/passes/relaxation_noise_pass.py "view source code")
