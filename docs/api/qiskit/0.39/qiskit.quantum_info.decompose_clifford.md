...
`decompose_clifford(clifford, method=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/quantum_info/synthesis/clifford_decompose.py "view source code")
