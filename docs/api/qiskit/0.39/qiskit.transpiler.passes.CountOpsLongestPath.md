...
`CountOpsLongestPath(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/analysis/count_ops_longest_path.py "view source code")
...
`CountOpsLongestPath.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/analysis/count_ops_longest_path.py "view source code")
