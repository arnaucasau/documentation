...
`QFI(qfi_method='lin_comb_full')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/gradients/qfi.py "view source code")
...
`QFI.convert(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/gradients/qfi.py "view source code")
