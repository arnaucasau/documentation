...
`ConverterBase`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/converters/converter_base.py "view source code")
...
`abstract ConverterBase.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/converters/converter_base.py "view source code")
