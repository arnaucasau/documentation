...
`AQCSynthesisPlugin`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/synthesis/aqc/aqc_plugin.py "view source code")
...
`AQCSynthesisPlugin.run(unitary, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/synthesis/aqc/aqc_plugin.py "view source code")
