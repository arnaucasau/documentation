...
`Call(subroutine, value_dict=None, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/instructions/call.py "view source code")
...
`Call.assigned_subroutine()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/instructions/call.py "view source code")
