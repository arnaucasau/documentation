...
`Collect2qBlocks(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/collect_2q_blocks.py "view source code")
...
`Collect2qBlocks.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/collect_2q_blocks.py "view source code")
