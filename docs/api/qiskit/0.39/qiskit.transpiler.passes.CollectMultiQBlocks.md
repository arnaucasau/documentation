...
`CollectMultiQBlocks(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py "view source code")
...
`CollectMultiQBlocks.find_set(index)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py "view source code")
...
`CollectMultiQBlocks.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py "view source code")
...
`CollectMultiQBlocks.union_set(set1, set2)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/optimization/collect_multiqubit_blocks.py "view source code")
