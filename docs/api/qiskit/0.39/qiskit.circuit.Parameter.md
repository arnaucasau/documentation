...
`Parameter(name)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/parameter.py "view source code")
...
`Parameter.subs(parameter_map)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/parameter.py "view source code")
