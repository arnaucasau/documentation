...
`SPSASamplerGradient(sampler, epsilon, batch_size=1, seed=None, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/gradients/spsa_sampler_gradient.py "view source code")
