...
`FakeValenciaV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/valencia/fake_valencia.py "view source code")
