...
`array_to_latex(array, precision=5, prefix='', source=False, max_size=8)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/visualization/array.py "view source code")
