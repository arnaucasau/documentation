...
`UnitarySimulator(configuration=None, properties=None, provider=None, **backend_options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/backends/unitary_simulator.py "view source code")
...
`UnitarySimulator.available_devices()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/backends/unitary_simulator.py "view source code")
...
`UnitarySimulator.available_methods()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/backends/unitary_simulator.py "view source code")
...
`UnitarySimulator.set_option(key, value)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/backends/unitary_simulator.py "view source code")
