...
`SamplingVQE(sampler, ansatz, optimizer, *, initial_point=None, aggregation=None, callback=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
...
`SamplingVQE.compute_minimum_eigenvalue(operator, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
...
`classmethod SamplingVQE.supports_aux_operators()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/minimum_eigensolvers/sampling_vqe.py "view source code")
