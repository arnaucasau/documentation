...
`FakeMelbourneV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/melbourne/fake_melbourne.py "view source code")
