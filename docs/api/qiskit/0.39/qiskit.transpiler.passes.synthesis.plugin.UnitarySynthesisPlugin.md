...
`UnitarySynthesisPlugin`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/synthesis/plugin.py "view source code")
...
`abstract UnitarySynthesisPlugin.run(unitary, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/synthesis/plugin.py "view source code")
