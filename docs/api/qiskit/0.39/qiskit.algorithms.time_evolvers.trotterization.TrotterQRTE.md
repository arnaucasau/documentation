...
`TrotterQRTE(product_formula=None, estimator=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/time_evolvers/trotterization/trotter_qrte.py "view source code")
...
`TrotterQRTE.evolve(evolution_problem)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/time_evolvers/trotterization/trotter_qrte.py "view source code")
...
`classmethod TrotterQRTE.supports_aux_operators()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/time_evolvers/trotterization/trotter_qrte.py "view source code")
