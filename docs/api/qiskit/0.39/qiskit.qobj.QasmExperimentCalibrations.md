...
`QasmExperimentCalibrations(gates)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/qobj/qasm_qobj.py "view source code")
...
`classmethod QasmExperimentCalibrations.from_dict(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/qobj/qasm_qobj.py "view source code")
...
`QasmExperimentCalibrations.to_dict()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/qobj/qasm_qobj.py "view source code")
