...
`FakeManhattanV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/backends/manhattan/fake_manhattan.py "view source code")
