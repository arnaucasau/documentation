...
`circuit_to_dagdependency(circuit, create_preds_and_succs=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/converters/circuit_to_dagdependency.py "view source code")
