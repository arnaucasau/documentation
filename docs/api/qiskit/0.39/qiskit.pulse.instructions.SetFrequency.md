...
`SetFrequency(frequency, channel, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/instructions/frequency.py "view source code")
