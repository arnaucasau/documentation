...
`ResultDecoder`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/ibmq/runtime/program/result_decoder.py "view source code")
...
`classmethod ResultDecoder.decode(data)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/ibmq/runtime/program/result_decoder.py "view source code")
