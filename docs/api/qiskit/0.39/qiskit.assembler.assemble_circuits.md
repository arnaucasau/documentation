...
`assemble_circuits(circuits, run_config, qobj_id, qobj_header)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/assembler/assemble_circuits.py "view source code")
