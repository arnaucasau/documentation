...
`BackendEstimator(backend, options=None, abelian_grouping=True, bound_pass_manager=None, skip_transpilation=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/backend_estimator.py "view source code")
...
`BackendEstimator.set_transpile_options(**fields)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/backend_estimator.py "view source code")
