...
`SaveSuperOp(num_qubits, label='superop', pershot=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/library/save_instructions/save_superop.py "view source code")
