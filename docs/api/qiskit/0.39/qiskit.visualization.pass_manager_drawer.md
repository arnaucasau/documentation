...
`pass_manager_drawer(pass_manager, filename=None, style=None, raw=False)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/visualization/pass_manager_visualization.py "view source code")
