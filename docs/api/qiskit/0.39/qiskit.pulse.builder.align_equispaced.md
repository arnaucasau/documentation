...
`align_equispaced(duration)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/pulse/builder.py "view source code")
...
![../\_images/qiskit.pulse.builder.align\_equispaced\_0\_0.png](/images/api/qiskit/0.39/qiskit.pulse.builder.align_equispaced_0_0.png)
