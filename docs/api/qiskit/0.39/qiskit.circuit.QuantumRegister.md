...
`QuantumRegister(size=None, name=None, bits=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/quantumregister.py "view source code")
...
`QuantumRegister.qasm()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/quantumregister.py "view source code")
