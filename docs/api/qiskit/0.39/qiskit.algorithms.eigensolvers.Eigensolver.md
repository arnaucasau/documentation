...
`Eigensolver`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/eigensolvers/eigensolver.py "view source code")
...
`abstract Eigensolver.compute_eigenvalues(operator, aux_operators=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/eigensolvers/eigensolver.py "view source code")
...
`classmethod Eigensolver.supports_aux_operators()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/eigensolvers/eigensolver.py "view source code")
