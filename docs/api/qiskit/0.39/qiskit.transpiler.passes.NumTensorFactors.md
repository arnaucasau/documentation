...
`NumTensorFactors(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/analysis/num_tensor_factors.py "view source code")
...
`NumTensorFactors.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/analysis/num_tensor_factors.py "view source code")
