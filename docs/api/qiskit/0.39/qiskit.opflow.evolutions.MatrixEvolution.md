...
`MatrixEvolution`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/evolutions/matrix_evolution.py "view source code")
...
`MatrixEvolution.convert(operator)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/evolutions/matrix_evolution.py "view source code")
