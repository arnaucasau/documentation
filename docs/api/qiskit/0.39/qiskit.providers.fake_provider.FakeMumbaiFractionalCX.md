...
`FakeMumbaiFractionalCX`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/fake_mumbai_v2.py "view source code")
...
`FakeMumbaiFractionalCX.qubit_properties(qubit)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/fake_mumbai_v2.py "view source code")
...
`FakeMumbaiFractionalCX.run(run_input, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/fake_provider/fake_mumbai_v2.py "view source code")
