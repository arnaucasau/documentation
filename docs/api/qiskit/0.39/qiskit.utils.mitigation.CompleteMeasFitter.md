...
`CompleteMeasFitter(results, state_labels, qubit_list=None, circlabel='')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
...
`CompleteMeasFitter.add_data(new_results, rebuild_cal_matrix=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
...
`CompleteMeasFitter.readout_fidelity(label_list=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
...
`CompleteMeasFitter.subset_fitter(qubit_sublist)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
