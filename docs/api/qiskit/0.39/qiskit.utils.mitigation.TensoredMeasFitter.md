...
`TensoredMeasFitter(results, mit_pattern, substate_labels_list=None, circlabel='')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
...
`TensoredMeasFitter.add_data(new_results, rebuild_cal_matrix=True)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
...
`TensoredMeasFitter.readout_fidelity(cal_index=0, label_list=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
...
`TensoredMeasFitter.subset_fitter(qubit_sublist)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/utils/mitigation/fitters.py "view source code")
