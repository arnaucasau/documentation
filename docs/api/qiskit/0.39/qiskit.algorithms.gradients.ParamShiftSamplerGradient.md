...
`ParamShiftSamplerGradient(sampler, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/algorithms/gradients/param_shift_sampler_gradient.py "view source code")
