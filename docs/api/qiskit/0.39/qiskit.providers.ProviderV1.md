...
`ProviderV1`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/provider.py "view source code")
...
`abstract ProviderV1.backends(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/provider.py "view source code")
...
`ProviderV1.get_backend(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/providers/provider.py "view source code")
