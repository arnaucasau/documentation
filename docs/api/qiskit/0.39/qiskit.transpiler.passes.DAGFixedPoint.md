...
`DAGFixedPoint(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/utils/dag_fixed_point.py "view source code")
...
`DAGFixedPoint.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/utils/dag_fixed_point.py "view source code")
