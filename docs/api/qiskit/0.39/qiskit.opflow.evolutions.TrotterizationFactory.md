...
`TrotterizationFactory`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/evolutions/trotterizations/trotterization_factory.py "view source code")
...
`static TrotterizationFactory.build(mode='trotter', reps=1)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/evolutions/trotterizations/trotterization_factory.py "view source code")
