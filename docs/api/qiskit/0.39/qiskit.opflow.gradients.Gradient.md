...
`Gradient(grad_method='param_shift', **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/gradients/gradient.py "view source code")
...
`Gradient.convert(operator, params=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/gradients/gradient.py "view source code")
...
`Gradient.get_gradient(operator, params)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/opflow/gradients/gradient.py "view source code")
