...
`BooleanExpression(expression, name=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/classicalfunction/boolean_expression.py "view source code")
...
`classmethod BooleanExpression.from_dimacs_file(filename)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/classicalfunction/boolean_expression.py "view source code")
...
`BooleanExpression.simulate(bitstring)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/classicalfunction/boolean_expression.py "view source code")
...
`BooleanExpression.synth(registerless=True, synthesizer=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/circuit/classicalfunction/boolean_expression.py "view source code")
