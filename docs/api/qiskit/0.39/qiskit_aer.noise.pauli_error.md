...
`pauli_error(noise_ops, standard_gates=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit_aer/noise/errors/standard_errors.py "view source code")
