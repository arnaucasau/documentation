...
`BaseEstimator(circuits: Iterable[QuantumCircuit] | QuantumCircuit | None = None, observables: Iterable[SparsePauliOp] | SparsePauliOp | None = None, parameters: Iterable[Iterable[Parameter]] | None = None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/base/base_estimator.py "view source code")
...
`BaseEstimator.close()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/base/base_estimator.py "view source code")
...
`BaseEstimator.run(circuits, observables, parameter_values=None, **run_options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/primitives/base/base_estimator.py "view source code")
