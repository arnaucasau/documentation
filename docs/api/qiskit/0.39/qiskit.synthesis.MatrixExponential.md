...
`MatrixExponential`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/synthesis/evolution/matrix_synthesis.py "view source code")
...
`MatrixExponential.synthesize(evolution)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/synthesis/evolution/matrix_synthesis.py "view source code")
