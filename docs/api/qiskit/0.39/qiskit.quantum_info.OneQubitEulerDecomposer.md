...
`OneQubitEulerDecomposer(basis='U3')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
...
`OneQubitEulerDecomposer.angles(unitary)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
...
`OneQubitEulerDecomposer.angles_and_phase(unitary)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/quantum_info/synthesis/one_qubit_decompose.py "view source code")
