...
`CheckGateDirection(*args, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/utils/check_gate_direction.py "view source code")
...
`CheckGateDirection.run(dag)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/transpiler/passes/utils/check_gate_direction.py "view source code")
