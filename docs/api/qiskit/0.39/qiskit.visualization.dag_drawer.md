...
`dag_drawer(dag, scale=0.7, filename=None, style='color')`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/visualization/dag_visualization.py "view source code")
