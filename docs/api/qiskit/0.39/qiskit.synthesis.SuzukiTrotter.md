...
`SuzukiTrotter(order=2, reps=1, insert_barriers=False, cx_structure='chain', atomic_evolution=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/synthesis/evolution/suzuki_trotter.py "view source code")
...
`SuzukiTrotter.synthesize(evolution)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.39/qiskit/synthesis/evolution/suzuki_trotter.py "view source code")
