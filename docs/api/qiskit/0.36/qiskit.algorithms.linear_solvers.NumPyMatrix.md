...
```python
<qiskit.circuit.instructionset.InstructionSet at 0x7f1d85cc11c0>
```
...
<span id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_density_matrix" />

`NumPyMatrix.snapshot_density_matrix(label, qubits=None)`
...
<span id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_expectation_value" />

`NumPyMatrix.snapshot_expectation_value(label, op, qubits, single_shot=False, variance=False)`
...
<span id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_probabilities" />

`NumPyMatrix.snapshot_probabilities(label, qubits, variance=False)`
...
<span id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_stabilizer" />

`NumPyMatrix.snapshot_stabilizer(label)`
...
<span id="qiskit.algorithms.linear_solvers.NumPyMatrix.snapshot_statevector" />

`NumPyMatrix.snapshot_statevector(label)`
