...
`FakeProviderForBackendV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/fake_provider.py "view source code")
...
`FakeProviderForBackendV2.backends(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/fake_provider.py "view source code")
...
`FakeProviderForBackendV2.get_backend(name=None, **kwargs)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/fake_provider.py "view source code")
