...
`FakeMontreal`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/backends/montreal/fake_montreal.py "view source code")
