...
`FakeAlmaden`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/backends/almaden/fake_almaden.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeAlmaden.defaults" />

`FakeAlmaden.defaults()`
...
<span id="qiskit.providers.fake_provider.FakeAlmaden.defs_filename" />
