...
`FakeJohannesburgV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/backends/johannesburg/fake_johannesburg.py "view source code")
