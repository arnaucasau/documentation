...
`FakeSingapore`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/backends/singapore/fake_singapore.py "view source code")
...
<span id="qiskit.providers.fake_provider.FakeSingapore.defaults" />

`FakeSingapore.defaults()`
...
<span id="qiskit.providers.fake_provider.FakeSingapore.defs_filename" />
