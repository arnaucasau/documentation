...
`FakeWashingtonV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/backends/washington/fake_washington.py "view source code")
