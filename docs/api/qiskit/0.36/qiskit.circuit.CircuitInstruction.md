...
`CircuitInstruction(operation, qubits=(), clbits=())`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/quantumcircuitdata.py "view source code")
...
`CircuitInstruction.copy()`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/quantumcircuitdata.py "view source code")
...
`CircuitInstruction.replace(operation=None, qubits=None, clbits=None)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/circuit/quantumcircuitdata.py "view source code")
