...
`FakeBackendV2`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
...
`FakeBackendV2.run(run_input, **options)`[GitHub](https://github.com/qiskit/qiskit/tree/stable/0.20/qiskit/providers/fake_provider/fake_backend_v2.py "view source code")
